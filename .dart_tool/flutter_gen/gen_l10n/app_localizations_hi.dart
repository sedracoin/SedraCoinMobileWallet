...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'क्या आप सुनिश्चित हैं कि आपने अपने गुप्त वाक्यांश या सीड का बैकअप ले लिया है?';
  ...
  @override
  String get createPasswordFirstParagraph => 'आप अपने वॉलेट में अतिरिक्त सुरक्षा जोड़ने के लिए एक पासवर्ड बना सकते हैं।';

  @override
  String get createPasswordHint => 'एक पासवर्ड बनाएं';

  @override
  String get createPasswordSecondParagraph => 'पासवर्ड वैकल्पिक है, और आपका वॉलेट आपके पिन या बायोमेट्रिक्स से सुरक्षित रहेगा ही।';
  ...
  @override
  String get emptyCardIntroUtxos => 'यह UTXOs टैब है। आपके बटुए में सभी UTXO यहां दिखाई देंगे';
  ...
  @override
  String get exampleCardIntro => 'यह लेन-देन टैब है। लेन-देन भेजने या प्राप्त करने के बाद, यह यहां दिखाई देगा।';
  ...
  @override
  String get importSecretPhraseHint => 'कृपया अपना 24-शब्द गुप्त वाक्यांश नीचे दर्ज करें। प्रत्येक शब्द को एक स्थान से अलग किया जाना चाहिए।';

  @override
  String get importSecretPhraseHintCombo => 'कृपया नीचे अपना 12 या 24 शब्दों का गुप्त वाक्यांश दर्ज करें।';

  @override
  String get importSecretPhraseHintLegacy => 'कृपया नीचे अपना 12 शब्दों का गुप्त वाक्यांश दर्ज करें।';
  ...
  @override
  String get insufficientBalanceDetails => 'आपके पास इस लेन-देन के लिए पर्याप्त SDR नहीं है';
  ...
  @override
  String get invalidChecksumMessage => 'कृपया जांचें कि आपका गुप्त वाक्यांश सही ढंग से दर्ज किया गया है!';

  @override
  String get invalidKpubMessage => 'कृपया जांचें कि आपकी विस्तारित पब्लिक की सही ढंग से दर्ज की गई है!';
  ...
  @override
  String get sedraDevFund => 'sedra Dev कोष';

  @override
  String get sedracoinWallet => 'कैस्पियम वॉलेट';
  ...
  @override
  String get logoutDialogContent => 'क्या आप वाकई इस वॉलेट से लॉगआउट करना चाहते हैं?';
  ...
  @override
  String get nodeAddress => 'Sedra नोड';

  @override
  String get nodeDeleteMessage => 'क्या आप आश्वस्त है कि आपको डिलीट करना है?';

  @override
  String get nodeDeleteTitle => 'Sedra नोड कॉन्फ़िग हटाएं?';
  ...
  @override
  String get nodesSheetTitle => 'sedra नोड्स';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'अब आपको कैस्पियम खोलने के लिए पासवर्ड की जरूरत नहीं पड़ेगी।';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'कैस्पियम खोलने के लिए इस पासवर्ड की आवश्यकता होगी।';

  @override
  String get passwordsDontMatch => 'पासवर्ड मेल नहीं खाते';

  @override
  String get pasteMnemonicError => 'क्लिपबोर्ड सामग्री मान्य गुप्त वाक्यांश नहीं है';
  ...
  @override
  String get removeWalletBiometricsMessage => 'वॉलेट हटाने के लिए प्रमाणित करें';

  @override
  String get removeWalletDetail => 'इस वॉलेट को हटाने से इस डिवाइस से गुप्त वाक्यांश और वॉलेट से संबंधित सभी डेटा हट जाएगा। यदि गुप्त वाक्यांश का बैकअप नहीं लिया जाता है, तो आप कभी भी अपने फंड तक दोबारा नहीं पहुंच पाएंगे।';

  @override
  String get removeWalletPinMessage => 'वॉलेट निकालने के लिए पिन दर्ज करें';

  @override
  String get removeWalletReassurance => 'जब तक आपने गुप्त वाक्यांश का बैकअप लिया है तब तक आपको चिंता करने की कोई बात नहीं है।';

  @override
  String get requireAPasswordToOpenHeader => 'कैस्पियम खोलने के लिए पासवर्ड की आवश्यकता रखें?';
  ...
  @override
  String get secretInfo => 'अगली स्क्रीन में, आप अपना गुप्त वाक्यांश देखेंगे। यह आपके फंड तक पहुंचने के लिए एक पासवर्ड है। यह महत्वपूर्ण है कि आप इसका बैकअप लें और इसे कभी किसी के साथ साझा न करें।';
  ...
  @override
  String get secretWarning => 'यदि आप अपना उपकरण खो देते हैं या एप्लिकेशन को अनइंस्टॉल कर देते हैं, तो आपको अपने फंड को पुनर्प्राप्त करने के लिए अपने गुप्त वाक्यांश या सीड की आवश्यकता होगी!';
  ...
  @override
  String get sendTxProgressDescription => 'लेन-देन भेजे जाने तक कृपया प्रतीक्षा करें';
  ...
  @override
  String get shareSedraCoin => 'शेयर कैपियम';

  @override
  String get shareSedraCoinSubject => 'कैस्पियम वॉलेट देखें';

  @override
  String get shareSedraCoinText => 'कैस्पियम - कास्पा मोबाइल वॉलेट देखें।\nवेबसाइट - sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR सफलतापूर्वक आपके कैपियम वॉलेट में स्थानांतरित कर दी गई है। \n';
  }
  ...
  @override
  String get transferConfirmInfoSecond => 'फंड ट्रांसफर करने के लिए कन्फर्म दबाएँ \n';

  @override
  String get transferConfirmInfoThird => 'स्थानांतरण को पूरा होने में कई सेकंड लग सकते हैं।';

  @override
  String get transferError => 'लेन-देन के दौरान एक त्रुटि हुई है। कृपया बाद में पुन: प्रयास करें।';
  ...
  @override
  String get transferNoFunds => 'इस सीड पर कोई SDR नहीं है';
  ...
  @override
  String get welcomeText => 'कैपियम में आपका स्वागत है। आगे बढ़ने के लिए, आप एक नया वॉलेट बना सकते हैं या एक मौजूदा वॉलेट को आयात कर सकते हैं।';
  ...
  @override
  String get sedraUriInvalid => 'अमान्य Sedra URI';
  ...
  @override
  String get scanFailedMessage => 'स्कैन विफल रहा, कृपया बाद में पुनः प्रयास करें';
  ...
  @override
  String get addressFilterDialogOptionNonZeroBalances => 'शेष राशि के साथ एड्रेस देखें';
  ...
  @override
  String get importOptionKpubDescription => 'विस्तारित पब्लिक की का उपयोग करके वॉलेट के संतुलन और लेनदेन की निगरानी करें';
  ...
  @override
  String get importKpubClipboardError => 'क्लिपबोर्ड सामग्री वैध विस्तारित पब्लिक की नहीं है';

  @override
  String get importKpubQrCodeError => 'QR कोड में वैध विस्तारित पब्लिक की नहीं है';

  @override
  String get importKpubInvalidMessage => 'कृपया जांचें कि आपकी विस्तारित पब्लिक की सही ढंग से दर्ज की गई है!';
