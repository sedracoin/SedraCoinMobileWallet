...
class AppLocalizationsBn extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'আপনি কি নিশ্চিত যে আপনি আপনার গোপন বাক্যাংশ বা সীড  ব্যাক আপ করেছেন?';
  ...
  @override
  String get addNodeFailed => 'Sedra নোড যোগ করা ব্যর্থ হয়েছে';
  ...
  @override
  String get addingNodeMessage => 'নোডের সাথে যোগাযোগ করার সময় অনুগ্রহ করে অপেক্ষা করুন';
  ...
  @override
  String get createPasswordFirstParagraph => 'আপনার ওয়ালেট এ অতিরিক্ত নিরাপত্তা যোগ করতে আপনি একটি পাসওয়ার্ড তৈরি করতে পারেন।';

  @override
  String get createPasswordHint => 'একটি পাসওয়ার্ড তৈরি করুন';

  @override
  String get createPasswordSecondParagraph => 'পাসওয়ার্ড হলো এক বিকল্প, এবং আপনার ওয়ালেট আপনার পিন বা বায়োমেট্রিক নির্বিশেষে সুরক্ষিত থাকবে।';
  ...
  @override
  String get emptyCardIntroUtxos => 'এটি UTXOs ট্যাব। আপনার ওয়ালেটের সমস্ত UTXO এখানে পরিলক্ষিত হবে';
  ...
  @override
  String get encryptionFailedError => 'ওয়ালেট পাসওয়ার্ড সেট করা ব্যর্থ হয়েছে';
  ...
  @override
  String get exampleCardIntro => 'এটা লেনদেন এর ট্যাব। একবার আপনি একটি লেনদেন প্রেরণ বা গ্রহণ করলে, এটি এখানে পরিলক্ষিত হবে৷';
  ...
  @override
  String get importSecretPhraseHint => 'নিচে আপনার 24 শব্দের গোপন বাক্যাংশ লিখুন.';

  @override
  String get importSecretPhraseHintCombo => 'নীচে আপনার 12 বা 24 শব্দের গোপন বাক্যাংশ লিখুন।';

  @override
  String get importSecretPhraseHintLegacy => 'নীচে আপনার 12 শব্দের গোপন বাক্যাংশ লিখুন।';
  ...
  @override
  String get insufficientBalanceDetails => 'এই লেনদেনের জন্য আপনার কাছে পর্যাপ্ত SDR নেই';
  ...
  @override
  String get invalidChecksumMessage => 'আপনার গোপন বাক্যাংশ চেক করুন\nসঠিকভাবে প্রবেশ করানো হয়েছে!';

  @override
  String get invalidKpubMessage => 'আপনার বর্ধিত পাবলিক কী সঠিকভাবে প্রবেশ করানো হয়েছে কিনা তা পরীক্ষা করুন!';
  ...
  @override
  String get sedraDevFund => 'কাসপা ডেভ তহবিল';

  @override
  String get sedracoinWallet => 'কাস্পিয়াম ওয়ালেট';
  ...
  @override
  String get logoutDialogContent => 'আপনি কি এই ওয়ালেট থেকে লগআউট করার বিষয়ে নিশ্চিত?';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'এই ওয়ালেট খুলতে আপনার আর পাসওয়ার্ড লাগবে না।';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'ওয়ালেট খোলার জন্য এই পাসওয়ার্ডের প্রয়োজন হবে।';

  @override
  String get passwordsDontMatch => 'পাসওয়ার্ড মিলছে না';

  @override
  String get pasteMnemonicError => 'ক্লিপবোর্ড এর বিষয়বস্তু একটি বৈধ গোপন বাক্যাংশ নয়';
  ...
  @override
  String get removeWalletBiometricsMessage => 'ওয়ালেট অপসারণ করতে প্রমাণীকরণ করুন';

  @override
  String get removeWalletDetail => 'এই ওয়ালেটটি অপসারণ করা হলে এই ডিভাইস থেকে গোপন বাক্যাংশ এবং সমস্ত ওয়ালেট-সম্পর্কিত ডেটা মুছে যাবে৷ যদি গোপন বাক্যাংশ ব্যাক আপ না করা হয়, তাহলে আপনি আর কখনও আপনার তহবিল অ্যাক্সেস করতে পারবেন না।';

  @override
  String get removeWalletPinMessage => 'ওয়ালেট অপসরণ করতে পিন লিখুন';

  @override
  String get removeWalletReassurance => 'যেহেতু আপনি গোপন বাক্যাংশটি ব্যাক আপ করেছেন তাই আপনার উদ্বিগ্ন হওয়ার কিছু নেই।';

  @override
  String get requireAPasswordToOpenHeader => 'এই ওয়ালেট খুলতে একটি পাসওয়ার্ড প্রয়োজন?';
  ...
  @override
  String get secretInfo => 'পরবর্তী পর্দায়, আপনি আপনার গোপন বাক্যাংশ দেখতে পাবেন। আপনার তহবিল অ্যাক্সেস করার জন্য এটি একটি পাসওয়ার্ড। এটি গুরুত্বপূর্ণ যে আপনি এটি ব্যাক আপ করুন এবং এটি কারও সাথে শেয়ার করবেন না।';
  ...
  @override
  String get secretWarning => 'আপনি যদি আপনার ডিভাইস হারিয়ে ফেলেন বা অ্যাপ্লিকেশনটি আনইনস্টল করেন, তাহলে আপনার তহবিল পুনরুদ্ধারের জন্য আপনার গোপন বাক্যাংশ বা সীড এর প্রয়োজন হবে!';
  ...
  @override
  String get sendTxProgressDescription => 'রাশি পাঠানো হযচ্ছে অনুগ্রহ করে অপেক্ষা করুন';
  ...
  @override
  String get shareSedraCoin => 'কাসপিয়াম শেয়ার করুন';

  @override
  String get shareSedraCoinSubject => 'কাসপিয়াম ওয়ালেট চেক আউট';

  @override
  String get shareSedraCoinText => 'কাসপিয়াম - কাসপা মোবাইল ওয়ালেট দেখুন।\nওয়েবসাইট - sedracoin.com';
  ...
  @override
  String get transferClose => 'এই উইন্ডো বন্ধ করতে যে কোনো জায়গায় আলতো চাপুন।';

  @override
  String transferComplete(String amount) {
    return '$amount SDR সফলভাবে আপনার SedraCoin Wallet এ স্থানান্তরিত হয়েছে৷৷\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount SDR ব্যালেন্স সহ একটি ওয়ালেট সনাক্ত করা হয়েছে৷';
  }

  @override
  String get transferConfirmInfoSecond => 'রাশি স্থানান্তর করতে নিশ্চিত করে আলতো চাপুন।\n';

  @override
  String get transferConfirmInfoThird => 'স্থানান্তর সম্পূর্ণ হতে কয়েক সেকেন্ড সময় লাগতে পারে।';

  @override
  String get transferError => 'স্থানান্তরের সময় একটি ত্রুটি ঘটেছে৷ অনুগ্রহ করে একটু পরে আবার চেষ্টা করুন।';
  ...
  String transferIntro(String button) {
    return 'এই প্রক্রিয়াটি পেপার ওয়ালেট থেকে আপনার SedraCoin ওয়ালেটে তহবিল স্থানান্তর করবে।\n\nশুরু করতে \"$button\" বোতামে ট্যাপ করুন।';
  }
  ...
  @override
  String get transferNoFunds => 'এই সিড এ কোন SDR নেই';

  @override
  String get transferQrScanError => 'এই QR কোডে বৈধ সিড নেই।';

  @override
  String get transferQrScanHint => 'একটি কাসপা সীড স্ক্যান করুন\nবা ব্যক্তিগত কী';
  ...
  @override
  String get welcomeText => 'কাস্পিয়ামে স্বাগতম। শুরু করার জন্য, আপনি একটি নতুন ওয়ালেট তৈরি করতে পারেন অথবা বিদ্যমান একটি ব্যবহার করতে পারেন।';
  ...
  @override
  String get sedraUriInvalid => 'অবৈধ Sedra URI';
  ...
  @override
  String get scanFailedMessage => 'স্ক্যান ব্যর্থ হয়েছে, অনুগ্রহ করে পরে আবার চেষ্টা করুন';
  ...
  @override
  String get addressFilterDialogOptionNonZeroBalances => 'ব্যালেন্স সহ ঠিকানা দেখুন';

  @override
  String get importOption24WordsTitle => '24 শব্দের গোপন বাক্যাংশ আমদানি করুন';

  @override
  String get importOption24WordsDescription => 'CLI ওয়ালেট এবং লেজারের সাথে সামঞ্জস্যপূর্ণ';

  @override
  String get importOption12WordsTitle => '12 শব্দের গোপন বাক্যাংশ আমদানি করুন';

  @override
  String get importOption12WordsDescription => 'ওয়েব ওয়ালেট এবং KDX এর সাথে সামঞ্জস্যপূর্ণ';

  @override
  String get importOptionKpubTitle => 'শুধুমাত্র পর্যবেক্ষণ করার ওয়ালেট আমদানি করুন';

  @override
  String get importOptionKpubDescription => 'একটি বর্ধিত পাবলিক কী ব্যবহার করে একটি ওয়ালেটের ব্যালেন্স এবং লেনদেন নিরীক্ষণ করুন';
  ...
  @override
  String get importKpubClipboardError => 'ক্লিপবোর্ড সামগ্রী একটি বৈধ বর্ধিত পাবলিক কী নয়';

  @override
  String get importKpubQrCodeError => 'QR কোডে একটি বৈধ বর্ধিত পাবলিক কী নেই';

  @override
  String get importKpubInvalidMessage => 'আপনার বর্ধিত পাবলিক কী সঠিকভাবে প্রবেশ করানো হয়েছে তা পরীক্ষা করুন!';
  ...
  @override
  String get hintAddressListEmpty => 'উপরের ডান কোণ থেকে ঠিকানা ফিল্টার চেক করুন';
