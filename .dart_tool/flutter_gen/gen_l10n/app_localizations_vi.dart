...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Bạn có chắc chắn rằng đã sao lưu cụm từ bí mật hoặc hạt giống của bạn?';
  ...
  @override
  String get createPasswordFirstParagraph => 'Bạn có thể tạo mật khẩu để tăng tính bảo mật cho ví của bạn.';

  @override
  String get createPasswordHint => 'Tạo mật khẩu';

  @override
  String get createPasswordSecondParagraph => 'Mật khẩu là tùy chọn không bắt buộc, và ví của bạn sẽ được bảo vệ với mã PIN hoặc sinh trắc học. ';
  ...
  @override
  String get exampleCardIntro => 'Chào mừng đến với SedraCoin. Khi bạn nhận Sedra, các giao dịch sẽ được hiển thị như sau:';
  ...
  @override
  String get importSecretPhraseHint => 'Hãy nhập 24 từ bí mật vào dưới đây. Mỗi từ phải được cách nhau bởi dấu cách.';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Bạn sẽ không cần mật khẩu để mở SedraCoin nữa.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Mật khẩu này sẽ được yêu cầu để mở SedraCoin.';
  ...
  @override
  String get qrInvalidSeed => 'Mã QR không chứa hạt giống hoặc khoá riêng tư hợp lệ';
  ...
  @override
  String get requireAPasswordToOpenHeader => 'Yêu cầu mật khẩu để mở SedraCoin?';
  ...
  @override
  String get secretInfo => 'Tiếp theo, bạn sẽ nhìn thấy một cụm từ bí mật. Nó là mật khẩu để truy cập vào ví của bạn. Đừng quên sao lưu nó lại và tuyệt đối không chia sẻ cho bất kỳ ai';
  ...
  @override
  String get secretWarning => 'Nếu bạn đánh mất thiết bị hoặc gỡ cài đặt ứng dụng, bạn sẽ cần cụm từ bí mật hoặc hạt giống để khôi phục ví của bạn.';
  ...
  @override
  String get shareSedraCoin => 'Chia sẻ SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Check out SedraCoin Wallet';

  @override
  String get shareSedraCoinText => 'Thử ngay SedraCoin! Ví Sedra di động chính thức!';
  ...
  String transferComplete(String amount) {
    return '$amount Sedra đã được chuyển vào ví SedraCoin của bạn.\n';
  }
  ...
  @override
  String get transferConfirmInfoThird => 'Có thể mất vài giây để hoàn thành giao dịch.';

  @override
  String get transferError => 'Đã có lỗi trong quá trình giao dịch, vui lòng thử lại sau.';
  ...
  String transferIntro(String button) {
    return 'Quá trình này sẽ chuyển toàn bộ số dư từ ví giấy sang ví SedraCoin của bạn.\n\nNhấn nút \"$button\" để bắt đầu.';
  }
  ...
  @override
  String get unlockBiometrics => 'Xác nhận mở khoá SedraCoin';

  @override
  String get unlockPin => 'Nhập mã PIN để mở khoá SedraCoin';
  ...
  @override
  String get welcomeText => 'Chào mừng đến với SedraCoin. Để bắt đầu, bạn có thể tạo ví mới hoặc nhập ví hiện có.';
