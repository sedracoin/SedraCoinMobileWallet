...
class AppLocalizationsCa extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'N\'estàs segur que has fet una còpia de seguretat de la teva frase secreta o llavor?';
  ...
  @override
  String get addNodeFailed => 'Error al afegir node Sedra';
  ...
  @override
  String get addingNodeMessage => 'Si us plau, espera mentre es contacta amb el node';
  ...
  @override
  String get checkCameraPermission => 'Si us plau, revisa el permís a la càmera';
  ...
  @override
  String get createPasswordFirstParagraph => 'Pots establir una contrasenya per afegir protecció addicional al teu moneder.';

  @override
  String get createPasswordHint => 'Crea una contrasenya';

  @override
  String get createPasswordSecondParagraph => 'La contrasenya és opcional, el teu moneder estarà protegit amb el PIN o les dades biomètriques.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Aquesta és la pestanya de UTXOs. Tots els UTXOs del teu moneder apareixeran aquí';
  ...
  @override
  String get encryptionFailedError => 'Error a l\'establir la contrasenya del moneder';
  ...
  @override
  String get exampleCardIntro => 'Benvingut a Natrium. Un cop hagis rebut SDR, les transaccions apareixeran així:';
  ...
  @override
  String get fingerprintSeedBackup => 'Autentica\'t per copiar la llavor i la frase secreta.';
  ...
  @override
  String get importSecretPhraseHint => 'Si us plau, introdueix la teva frase secreta de 24 paraules a sota. Cada paraula ha d\'estar separada per un espai.';
  ...
  @override
  String get insufficientBalanceDetails => 'No tens suficient SDR per a aquesta transacció';
  ...
  @override
  String get invalidChecksumMessage => 'Si us plau, comprova que la teva Frase secreta\ns\'ha introduït correctament!';
  ...
  @override
  String get sedraDevFund => 'Fons de Desenvolupadors Sedra';

  @override
  String get sedracoinWallet => 'Moneder SedraCoin';
  ...
  @override
  String get nodeDeleteTitle => 'Esborrar la configuració del Node Sedra?';
  ...
  @override
  String get nodesSheetTitle => 'Nodes Sedra';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Ja no requeriràs una contrasenya per obrir Natrium.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Es requerirà aquesta contrasenya per obrir Natrium.';

  @override
  String get passwordsDontMatch => 'Les contrasenyes no coincideixen';

  @override
  String get pasteMnemonicError => 'El contingut del porta-retalls no és una frase secreta correcta';
  ...
  @override
  String get pinSeedBackup => 'Introdueix el PIN per copiar la llavor i la frase secreta';
  ...
  @override
  String get qrInvalidSeed => 'El codi QR no conté una llavor o clau privada vàlida';
  ...
  @override
  String get removeWalletDetail => 'Al esborrar aquest moneder, s\'esborrarà la frase secreta i totes les dades relacionades amb aquest moneder en aquest dispositiu. Si no tens còpia de la frase secreta, mai més podràs accedir als teus fons.';

  @override
  String get removeWalletPinMessage => 'Introduir PIN per eliminar el moneder';

  @override
  String get removeWalletReassurance => 'Sempre que tinguis una còpia de la teva frase secreta, no tens per què preocupar-te';

  @override
  String get requireAPasswordToOpenHeader => 'Vols requerir una contrasenya per obrir Natrium?';
  ...
  @override
  String get secretInfo => 'En la següent pantalla, veuràs una frase secreta. És una contrasenya per accedir als teus fons. És crucial que en facis una còpia de seguretat i no la comparteixis amb ningú.';
  ...
  @override
  String get secretWarning => 'Si perds el teu dispositiu o desinstal·les l\'aplicació, necessitaràs la teva frase secreta o llavor per recuperar els teus fons!';
  ...
  @override
  String get sendTxProgressDescription => 'Si us plau, espera mentres la transacció s\'envia';
  ...
  @override
  String get shareSedraCoinSubject => 'Veure el moneder de SedraCoin';

  @override
  String get shareSedraCoinText => 'Mira SedraCoin - Sedra Moneder Mòbil.\nWeb - sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR han estat transferits amb èxit al teu moneder Natrium.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'S\'ha detectat un moneder amb un saldo de $amount SDR.\n';
  }

  @override
  String get transferConfirmInfoSecond => 'La transferència pot tardar uns quants segons a completar-se.\n';

  @override
  String get transferConfirmInfoThird => 'La transferència pot tardar uns quants segons a completar-se.';

  @override
  String get transferError => 'S\'ha produït un error en la transferència. Si us plau, intenta-ho més tard.';
  ...
  @override
  String get transferNoFunds => 'Aquesta llavor no conté cap SDR';

  @override
  String get transferQrScanError => 'Aquest codi QR no conté una llavor vàlida.';

  @override
  String get transferQrScanHint => 'Escaneja una llavor\no clau privada Sedra';
  ...
  String welcomeMessage(String version) {
    return 'Benvingut/uda!\n\nAquesta és la versió $version de SedraCoin - el moneder mòbil per Sedra';
  }

  @override
  String get welcomeText => 'Benvingut a Natrium. Per començar, pots crear un nou moneder o importar-ne un d\'existent.';
  ...
  String xMinutes(int minutes) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      minutes,
      locale: localeName,
      other: '$minutesString minuts',
      one: '1 minut',
    );
    return 'Després de $_temp0';
  }
