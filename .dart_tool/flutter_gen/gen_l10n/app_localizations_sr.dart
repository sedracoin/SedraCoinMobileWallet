...
class AppLocalizationsSr extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Да ли сте сигурни да сте направили резервну копију ваше тајне фразе?';
  ...
  @override
  String get addNodeFailed => 'Додавање Sedra чвора није успело';
  ...
  @override
  String get authBiometricMessage => 'Аутентификујте се да Бисте Додали Новчаник';
  ...
  @override
  String get createPasswordFirstParagraph => 'Можеш креирати шифру ради додатног обезбеђења новчаника';

  @override
  String get createPasswordHint => 'Креирај шифру.';

  @override
  String get createPasswordSecondParagraph => 'Шифра је опционална, и ваш новчаник ће бити заштићен са ПИНом или Биометриком без обзира на шифру.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Ово је УТИКСО таб. Сви УТИКСОс у вашем новчанику ће бити приказани овде.';
  ...
  @override
  String get exampleCardIntro => 'Ово је таб за трансакције, Када пошаљете или примите трансакцију, приказађе се овде.';
  ...
  @override
  String get fingerprintSeedBackup => 'Аутентификујте се да Бисте направили резервну копију тајне фразе.';
  ...
  @override
  String get importSecretPhraseHint => 'Унесите ваше 24 речи тајне фразе испод.';
  ...
  @override
  String get insufficientBalanceDetails => 'Немате довољно SDR за ову трансакцију';
  ...
  @override
  String get invalidChecksumMessage => ' Молимо проверите да ли је ваша Тајна Фраза унета исправно!';
  ...
  @override
  String get sedraDevFund => 'Каспа Дев Фонд';

  @override
  String get sedracoinWallet => 'Каспиум Новчаник';
  ...
  @override
  String get logoutDialogContent => 'Да ли сте сигурни да желите да се одјавите са новчаника?';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Више вам неће требати шифра како би отворили новчаник.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Ова шифра ће бити потребна за откључавање новчаника.';

  @override
  String get passwordsDontMatch => 'Шифре се не подударају';

  @override
  String get pasteMnemonicError => 'Садржај клипбоарда није валидна тајна фраза';
  ...
  @override
  String get qrInvalidSeed => 'КЈУ-АР код не садржи валидно семе или приватан кључ';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Аутентификујте се Ради Брисања Новчаника';

  @override
  String get removeWalletDetail => 'Брисање овог новчаника ће обрисати Тајну Фразу и све податке везане за новчаник са овог уређаја. Уколико не постоји резевна копија Тајне Фразе нећете моћи поново приступити вашим средствима.';

  @override
  String get removeWalletPinMessage => 'Унеси ПИН да Обришеш Новчаник';

  @override
  String get removeWalletReassurance => 'Ако сте направили тачну резервну копију Тајне Фразе немате о чему да бринете.';

  @override
  String get requireAPasswordToOpenHeader => 'Захтевај шифру при отварању овог новчаника?';
  ...
  @override
  String get secretInfo => 'На следећем екрану, видећете вашу тајну фразу. Она је шифра за приступ вашим средствима. Од пресудног је значаја да направите резервну копију и да је никада не поделите нисаким.';
  ...
  @override
  String get secretWarning => 'Уколико изгубите овај уређај или деинсталирате апликацију, биће вам потребна ваша тајна фраза да повратите приступ средствима!';
  ...
  @override
  String get sendTxProgressDescription => 'Молимо сачекајте док се трансакција шаље';
  ...
  @override
  String get sentTo => 'Пошалјите до';
  ...
  @override
  String get shareSedraCoin => 'Подели Каспиум';

  @override
  String get shareSedraCoinSubject => 'Погледај Каспиум Новчаник';

  @override
  String get shareSedraCoinText => 'Погледај Каспиум - Каспа Мобилни Новчаник.\nВебсајт - sedracoin.com';
  ...
  @override
  String get transferConfirmInfoSecond => 'Кликни да потврдиш слање средстава.\n';

  @override
  String get transferConfirmInfoThird => 'Пренос може трајати више секунди.';

  @override
  String get transferError => 'Дошло је до грешке приликом трансфера. Молимо покушајте касније.';
  ...
  @override
  String get welcomeText => 'Добродошли у Каспиум. Да започнете, можете креирати нов новчаник или увезти већ постојеђи.';
