...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Вы уверены, что вы сохранили резервную копию вашей seed-фразы?';
  ...
  @override
  String get addNodeFailed => 'Не удалось добавить ноду Sedra';
  ...
  @override
  String get addingNodeMessage => 'Дождитесь, пожалуйста, установления связи с нодой';
  ...
  @override
  String get authBiometricMessage => 'Аутентифицируйтесь, чтобы добавить кошелек';
  ...
  @override
  String get checkCameraPermission => 'Проверьте, пожалуйста, права на использование камеры';
  ...
  @override
  String get createPasswordFirstParagraph => 'Вы можете создать пароль для дополнительной безопасности кошелька.';

  @override
  String get createPasswordHint => 'Создать пароль';

  @override
  String get createPasswordSecondParagraph => 'Пароль не является обязательным, ваш кошелек будет защищен PIN-кодом или биометрической информацией и без пароля.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Это вкладка с выходом неизрасходованных транзакций - UTXO. Здесь будут отображаться все UTXO вашего кошелька.';
  ...
  @override
  String get errorMessageCopied => 'Сообщение об ошибке скопировано в буфер обмена';

  @override
  String get exampleCardIntro => 'Это - вкладка с транзакциями. При получении или отправке транзакции она будет отображаться здесь.';
  ...
  @override
  String get fingerprintSeedBackup => 'Аутентификация для резервного копирования seed-фразы.';
  ...
  @override
  String get importSecretPhraseHint => 'Пожалуйста, введите вашу секретную фразу из 24 слов ниже. Каждое слово должно быть разделено пробелом.';

  @override
  String get importSecretPhraseHintCombo => 'Пожалуйста, введите свою секретную фразу из 12 или 24 слов ниже.';

  @override
  String get importSecretPhraseHintLegacy => 'Пожалуйста, введите свою секретную фразу из 12 слов ниже.';
  ...
  @override
  String get insufficientBalanceDetails => 'У вас не хватает SDR для этой транзакции';
  ...
  @override
  String get invalidChecksumMessage => 'Удостоверьтесь, пожалуйста, что секретная фраза\nвведена корректно!';

  @override
  String get invalidKpubMessage => 'Проверьте, пожалуйста, правильность ввода расширенного публичного ключа!';
  ...
  @override
  String get sedraDevFund => 'Фонд разработки Каспы';

  @override
  String get sedracoinWallet => 'Кошелёк SedraCoin';
  ...
  @override
  String get nodeAddress => 'Нода Sedra';

  @override
  String get nodeDeleteMessage => 'Вы уверены, что хотите удалить?';

  @override
  String get nodeDeleteTitle => 'Удалить конфигурацию ноды Sedra?';
  ...
  @override
  String get nodesSheetTitle => 'Ноды Sedra';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Вам больше не понадобится пароль, чтобы открыть этот кошелек.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Этот пароль будет нужен, чтобы открыть даный кошелёк.';

  @override
  String get passwordsDontMatch => 'Пароли не совпадают';

  @override
  String get pasteMnemonicError => 'Содержимое буфера обмена не является корректной seed-фразой';
  ...
  @override
  String get pinSeedBackup => 'Введите PIN-код, чтобы выполнить резервное копирование seed-фразы';
  ...
  @override
  String get qrInvalidSeed => 'QR-код не содержит корректной seed-фразы или приватного ключа';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Аутентифицируйтесь, чтобы удалить кошелек';

  @override
  String get removeWalletDetail => 'Удаление кошелька удалит с этого устройства seed-фразу кошелька и все относящиеся к нему данные. Если вы не создали и сохранили резервную копию seed-фразы в надежном месте - вы больше никогда не сможете получить доступ к своим средствам.';

  @override
  String get removeWalletPinMessage => 'Введите PIN-код, чтобы удалить кошелек';

  @override
  String get removeWalletReassurance => 'Если вы сохранили seed-фразу в безопасном месте - вам не о чем беспокоиться.';

  @override
  String get requireAPasswordToOpenHeader => 'Требовать пароль для открытия кошелька?';
  ...
  @override
  String get secretInfo => 'На следующем экране вы увидите свою seed-фразу. Она - ключ для управления вашими средствами. Крайне важно, чтобы вы создали ее резервную копию и никогда никому ee не передавали.';
  ...
  @override
  String get secretWarning => 'Если вы потеряете свое устройство или удалите приложение, вам понадобится ваша секретная seed фраза - чтобы вернуть свои средства!';
  ...
  @override
  String get sendTxProgressDescription => 'Пожалуйста, подождите, пока транзакция будет отправлена';
  ...
  @override
  String get shareSedraCoin => 'Поделиться SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Попробуйте кошелёк SedraCoin';

  @override
  String get shareSedraCoinText => 'Попробуйте SedraCoin - мобильный кошелёк Sedra.\nВеб-сайт - sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR успешно переведено в кошелёк SedraCoin.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Обнаружен кошелёк с балансом $amount SDR.';
  }

  @override
  String get transferConfirmInfoSecond => 'Для перевода средств нажмите кнопку \'подтвердить\'.\n';

  @override
  String get transferConfirmInfoThird => 'Перевод может занять несколько секунд.';

  @override
  String get transferError => 'Во время передачи произошла ошибка. Пожалуйста, попробуйте позже.';
  ...
  String transferIntro(String button) {
    return 'Этот процесс переведёт средства с бумажного кошелька на ваш кошелёк SedraCoin.\n\nНажмите кнопку \"$button\" чтобы начать.';
  }
  ...
  @override
  String get transferNoFunds => 'Эта seed-фраза не имеет SDR.';

  @override
  String get transferQrScanError => 'Этот QR-код не содержит достоверной seed-фразы.';

  @override
  String get transferQrScanHint => 'Сканировать seed-фразу \nSedra или приватный ключ';
  ...
  @override
  String get unlockBiometrics => 'Аутентифицируйтесь для разблокировки кошелька';
  ...
  String welcomeMessage(String version) {
    return 'Добро пожаловать!\n\nЭто версия $version SedraCoin - мобильного кошелька Sedra';
  }

  @override
  String get welcomeText => 'Добро пожаловать в SedraCoin. Вы можете создать новый кошелек или импортировать уже существующий.';
  ...
  @override
  String get sedraUriInvalid => 'Недействительный URI Sedra';
  ...
  @override
  String get scanFailedMessage => 'Сканирование не удалось, повторите попытку позже';
  ...
  @override
  String get addressFilterDialogOptionNonZeroBalances => 'Просмотреть адреса с балансом';

  @override
  String get importOption24WordsTitle => 'Импортировать секретную фразу из 24 слов';

  @override
  String get importOption24WordsDescription => 'Совместим с кошельком командной строки CLI и Ledger';

  @override
  String get importOption12WordsTitle => 'Импортировать секретную фразу из 12 слов';

  @override
  String get importOption12WordsDescription => 'Совместим с кошельком командной строки CLI и Ledger';

  @override
  String get importOptionKpubTitle => 'Импортировать кошелек только для просмотра';

  @override
  String get importOptionKpubDescription => 'Наблюдать за балансом и транзакциями кошелька с помощью расширенного публичного ключа';

  @override
  String get importKpub => 'Импортировать кошелек только для просмотра';

  @override
  String get importKpubHint => 'Пожалуйста, введите свой расширенный публичный ключ.';

  @override
  String get importKpubClipboardError => 'Содержимое буфера обмена не является действительным расширенным публичным ключом';

  @override
  String get importKpubQrCodeError => 'QR-код не содержит действительного расширенного публичного ключа';

  @override
  String get importKpubInvalidMessage => 'Проверьте, пожалуйста, правильность ввода расширенного публичного ключа!';
  ...
  @override
  String get hintAddressListEmpty => 'Проверьте фильтр адресов в правом верхнем углу';
