...
class AppLocalizationsIt extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Sei sicuro di aver fatto una copia della tua frase segreta?';
  ...
  @override
  String get addNodeFailed => 'Impossibile aggiungere nodo Sedra';
  ...
  @override
  String get authBiometricMessage => 'Autenticazione necessaria per aggiungere un wallet';
  ...
  @override
  String get checkCameraPermission => 'Controlla il permesso di accesso alla fotocamera';
  ...
  @override
  String get createPasswordFirstParagraph => 'Puoi creare una password per rendere il tuo wallet ancora più sicuro.';

  @override
  String get createPasswordHint => 'Crea una password';

  @override
  String get createPasswordSecondParagraph => 'La password è opzionale e il tuo wallet sarà comunque protetto dal PIN o dal riconoscimento biometrico.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Questa è la sezione dedicata agli UTXO. Tutti gli UTXO del tuo wallet appariranno qui';
  ...
  @override
  String get exampleCardIntro => 'Questa è la sezione dedicata alle transazioni. Quando invierai o riceverai una transazione, sarà visualizzata qui.';
  ...
  @override
  String get fingerprintSeedBackup => 'Conferma l\'impronta per eseguire il backup della frase segreta';
  ...
  @override
  String get importSecretPhraseHint => 'Inserisci la tua frase segreta di 24 parole.';
  ...
  @override
  String get insufficientBalanceDetails => 'Non hai abbastanza SDR per questa transazione';
  ...
  @override
  String get invalidChecksumMessage => 'Verifica che la tua frase segreta\n sia inserita correttamente!';

  @override
  String get invalidKpubMessage => 'Please check that your extended public key is entered correctly!';

  @override
  String get invalidDestinationAddress => 'L\'indirizzo di destinazione inserito non è valido';

  @override
  String get invalidPassword => 'La password inserita non è valida';

  @override
  String get sedraDevFund => 'Fondo dei developer di Sedra';
  ...
  @override
  String get logoutDialogContent => 'Sei sicuro di volerti disconnettere da questo wallet?';
  ...
  @override
  String get nodeDeleteTitle => 'Vuoi cancellare la configurazione del nodo Sedra?';
  ...
  @override
  String get nodesSheetTitle => 'Nodi Sedra';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Non avrai bisogno di una password per aprire questo wallet.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Questa password ti sarà richiesta per aprire questo wallet.';

  @override
  String get passwordsDontMatch => 'Le password non corrispondono';

  @override
  String get pasteMnemonicError => 'Il contenuto copiato non è una frase segreta valida';
  ...
  @override
  String get pinSeedBackup => 'Inserisci il PIN per eseguire il backup della frase segreta';
  ...
  @override
  String get qrInvalidAddress => 'Il codice QR non contiene un indirizzo valido';

  @override
  String get qrInvalidSeed => 'Il codice QR non contiene un seed o una chiave privata validi';

  @override
  String get qrMnemonicError => 'Il codice QR non contiene una frase segreta valida';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Autenticati per eliminare il wallet';

  @override
  String get removeWalletDetail => 'Eliminando questo wallet la frase segreta e tutti i dati del wallet saranno rimossi da questo dispositivo. Se non hai effettuato un backup della frase segreta, non sarai più in grado di accedere ai tuoi fondi.';

  @override
  String get removeWalletPinMessage => 'Inserisci il PIN per eliminare il wallet';

  @override
  String get removeWalletReassurance => 'Se hai effettuato correttamente il backup della frase segreta, puoi stare tranquillo.';

  @override
  String get requireAPasswordToOpenHeader => 'Vuoi impostare una password per accedere a questo wallet?';
  ...
  @override
  String get secretInfo => 'Nella prossima schermata, vedrai la tua frase segreta. È la password per accedere ai tuoi fondi. È fondamentale che tu ne faccia una copia e che non la condivida con nessuno.';
  ...
  @override
  String get secretWarning => 'Se perdi il tuo dispositivo o disinstalli l\'applicazione, avrai bisogno della tua frase segreta per recuperare i tuoi fondi!';
  ...
  @override
  String get sendError => 'Si è verificato un errore. Si prega di riprovare più tardi.';
  ...
  @override
  String get sentTo => 'Inviata a';

  @override
  String get setPassword => 'Imposta Password';

  @override
  String get setPasswordSuccess => 'La password è stata impostata correttamente';
  ...
  @override
  String get shareSedraCoin => 'Condividi SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Dai un\'occhiata al wallet SedraCoin';

  @override
  String get shareSedraCoinText => 'Dai un\'occhiata a SedraCoin, il wallet mobile di Sedra!\nWebsite - sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR trasferiti con successo al tuo wallet SedraCoin.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Rilevato un wallet con un saldo di $amount SDR.\n';
  }

  @override
  String get transferConfirmInfoSecond => 'Premi Conferma per trasferire i fondi.\n';

  @override
  String get transferConfirmInfoThird => 'Il trasferimento potrebbe richiedere diversi secondi.';

  @override
  String get transferError => 'Si è verificato un errore durante il trasferimento. Riprova più tardi.';
  ...
  String transferIntro(String button) {
    return 'Questo processo trasferirà i fondi da un wallet cartaceo al tuo wallet SedraCoin.\n\nPremi il pulsante \"$button\" per iniziare.';
  }
  ...
  @override
  String get transferNoFunds => 'Questo seed non contiene alcun SDR.';

  @override
  String get transferQrScanError => 'Questo codice QR non contiene un seed valido.';
  ...
  String welcomeMessage(String version) {
    return 'Benvenuto!\n\nQuesta è la versione $version di SedraCoin - il wallet mobile per Sedra ';
  }

  @override
  String get welcomeText => 'Benvenuto in SedraCoin. Per iniziare, puoi creare un nuovo wallet o importare un wallet già esistente.';
