...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Czy jesteś pewny/a że zapisałeś/aś sekretną frazę?';
  ...
  @override
  String get addNodeFailed => 'Nie udało się dodać węzła sieciowego Sedra';
  ...
  @override
  String get createPasswordFirstParagraph => 'Możesz ustawić hasło, aby zwiększyć bezpieczeństwo swojego portfela.';

  @override
  String get createPasswordHint => 'Utwórz hasło';

  @override
  String get createPasswordSecondParagraph => 'Hasło jest opcjonalne, a twój portfel niezależnie od niego będzie chroniony za pomocą kodu PIN lub biometrii.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Tu jest sekcja niewydanej reszty UTXO, wszystkie UTXO w twoim portfelu pojawią się tutaj.';
  ...
  @override
  String get exampleCardIntro => 'Tu znajduje się zakładka transakcji. Gdy wyślesz lub otrzymasz transakcję, pojawi się tutaj.';
  ...
  @override
  String get fingerprintSeedBackup => 'Autoryzuj się, aby utworzyć kopię zapasową sekretnego hasła.';
  ...
  @override
  String get importSecretPhraseHint => 'Wpisz swoją sekretną frazę, która składa się z 24 słów. Każde słowo powinno być oddzielone spacją.';

  @override
  String get importSecretPhraseHintCombo => 'Wprowadź swoją sekretna frazę składającą się z 12 lub 24 słów poniżej.';

  @override
  String get importSecretPhraseHintLegacy => 'Wprowadź swoją sekretną frazę składającą się z 12 słów poniżej.';
  ...
  @override
  String get insufficientBalanceDetails => 'Nie masz wystarczającej ilości SDR, aby dokonać tej transakcji';
  ...
  @override
  String get invalidChecksumMessage => 'Proszę sprawdzić, czy poprawnie wpisałeś \nswój sekretny seed!';

  @override
  String get invalidKpubMessage => 'Sprawdź czy twój rozszerzony klucz publiczny jest wprowadzony poprawnie!';
  ...
  @override
  String get sedraDevFund => 'Fundusz rozwoju Sedra';

  @override
  String get sedracoinWallet => 'Portfel SedraCoin';
  ...
  @override
  String get logoutDialogContent => 'Czy na pewno chcesz wylogować się z tego portfela?';
  ...
  @override
  String get nodeAddress => 'Węzeł sieciowy Sedra';

  @override
  String get nodeDeleteMessage => 'Czy na pewno chcesz usunąć?';

  @override
  String get nodeDeleteTitle => 'Usunąć konfigurację węzła sieciowego Sedra?';
  ...
  @override
  String get nodesSheetTitle => 'Węzły sieciowe Sedra';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => ' Nie będziesz potrzebował hasła do otworzenia tego portfela.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'To hasło będzie wymagane do otwarcia tego portfela.';

  @override
  String get passwordsDontMatch => 'Hasła nie zgadzają się';

  @override
  String get pasteMnemonicError => 'Zawartość schowka nie jest poprawną tajną frazą';
  ...
  @override
  String get pinSeedBackup => 'Wprowadź kod PIN w celu zabezpieczenia frazy sekretnej';
  ...
  @override
  String get qrInvalidSeed => 'Kod QR nie zawiera poprawnego seed\'a lub klucza prywatnego';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Wprowadź hasło, aby usunąć portfel';

  @override
  String get removeWalletDetail => 'Usunięcie tego portfela spowoduje usunięcie z tego urządzenia hasła i wszystkich danych związanych z portfelem. Jeśli sekretna fraza nie zostanie zapisana w innym miejscu, nigdy nie będziesz mógł/a ponownie uzyskać dostępu do swoich środków.';

  @override
  String get removeWalletPinMessage => 'Wpisz kod PIN, aby usunąć portfel';

  @override
  String get removeWalletReassurance => 'Dopóki masz kopię zapasową sekretnej frazy w bezpiecznym miejscu - nie masz nad czym martwić.';

  @override
  String get requireAPasswordToOpenHeader => 'Wymagać hasła, aby otworzyć ten portfel?';
  ...
  @override
  String get secretInfo => 'Na następnym ekranie zobaczysz swoją sekretną frazę. Jest to hasło umożliwiające dostęp do twoich środków. Ważne jest, aby ją zapisać i nigdy nie udostępniać komukolwiek.';
  ...
  @override
  String get secretWarning => 'Jeśli zgubisz urządzenie lub odinstalujesz aplikację, będziesz potrzebował\\a tajnej frazy, aby odzyskać swoje fundusze!';
  ...
  @override
  String get sendTxProgressDescription => 'Proszę poczekać, aż transakcja zostanie wysłana';
  ...
  @override
  String get shareSedraCoin => 'Udostępnij SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Zapoznaj się z SedraCoin';

  @override
  String get shareSedraCoinText => 'Zapoznaj się z mobilnym portfelem SedraCoin. \nStrona internetowa - sedracoin.com.';
  ...
  @override
  String get tooManyFailedAttempts => 'Zbyt wiele nieudanych prób odblokowania.';
  ...
  String transferComplete(String amount) {
    return '$amount SDR zostało pomyślnie przekazanych na twój portfel SedraCoin.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Został wykryty portfel z saldem $amount SDR.';
  }

  @override
  String get transferConfirmInfoSecond => 'Naciśnij potwierdź, aby transferować środki.\n';

  @override
  String get transferConfirmInfoThird => 'Transfer może potrwać kilka sekund, zanim zostanie zakończony.';

  @override
  String get transferError => 'Podczas transferu wystąpił błąd. Spróbuj ponownie później.';
  ...
  String transferIntro(String button) {
    return 'Ten proces przeniesie środki z papierowego portfela do portfela SedraCoin.\n\nStuknij w przycisk \"$button\", aby rozpocząć.';
  }
  ...
  @override
  String get transferNoFunds => 'Ta seed fraza nie zawiera żadnego SDR';

  @override
  String get transferQrScanError => 'Ten kod QR nie zawiera poprawnej frazy seed.';

  @override
  String get transferQrScanHint => 'Zeskanuj seed frazę\nSedra lub klucz prywatny';
  ...
  String welcomeMessage(String version) {
    return 'Witaj!\n\nTo wersja $version SedraCoin - portfela mobilnego Sedra.';
  }

  @override
  String get welcomeText => 'Witaj w SedraCoin. Aby rozpocząć, możesz stworzyć nowy portfel lub zaimportować istniejący.';
  ...
  @override
  String get sedraUriInvalid => 'Nieprawidłowe URI Sedra';
  ...
  @override
  String get scanFailedMessage => 'Skanowanie nie powiodło się, spróbuj ponownie później';
  ...
  @override
  String get addressFilterDialogOptionAllAddresses => 'Wyświetl wszystkie adresy';

  @override
  String get addressFilterDialogOptionNonZeroBalances => 'Wyświetl adresy, na których jest Sedra';

  @override
  String get importOption24WordsTitle => 'Importuj 24-słowną tajną frazę';

  @override
  String get importOption24WordsDescription => 'Kompatybilny z portfelem Cli i Ledger';

  @override
  String get importOption12WordsTitle => 'Importuj 12-słowną tajną frazę';

  @override
  String get importOption12WordsDescription => 'Kompatybilny z portfelem Web i KDX';

  @override
  String get importOptionKpubTitle => 'Importuj portfel w trybie tylko do oglądania';

  @override
  String get importOptionKpubDescription => 'Monitoruj saldo i transakcje portfela, korzystając z rozszerzonego klucza publicznego';
  ...
  @override
  String get importKpubClipboardError => 'Zawartość schowka nie jest prawidłowym rozszerzonym kluczem publicznym';

  @override
  String get importKpubQrCodeError => 'Kod QR nie zawiera prawidłowego rozszerzonego klucza publicznego';

  @override
  String get importKpubInvalidMessage => 'Sprawdź, czy rozszerzony klucz publiczny został wprowadzony poprawnie!';
  ...
  @override
  String get hintAddressListEmpty => 'Sprawdź filtr adresów w prawym górnym rogu';
