...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get createPasswordFirstParagraph => 'パスワードを設定してウォレットのセキュリティを追加することができます。';

  @override
  String get createPasswordHint => 'パスワードを作成する';

  @override
  String get createPasswordSecondParagraph => 'パスワードの設定は任意ですが、いずれにしてもウォレットはピンまたは生体認証で保護されます。';
  ...
  @override
  String get importSecretPhraseHint => '以下に24語のシークレットフレーズを入力してください。各単語はスペースで区切ります。';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Natriumを開く際にパスワードを必要としなくなります。';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'このパスワードはNatriumを開く際に必要となります。';
  ...
  @override
  String get secretInfo => '次の画面で、シークレットフレーズが表示されます。資金にアクセスするためのパスワードです。バックアップして、誰とも共有しないでください。';
  ...
  @override
  String get secretWarning => 'デバイスを紛失したり、アプリケーションをアンインストールした場合、資金を回収するためにシークレットフレーズまたはシードが必要になります！';
