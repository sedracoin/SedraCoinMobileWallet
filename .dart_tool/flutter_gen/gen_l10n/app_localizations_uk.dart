...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Ви впевнені, що зробили резервну копію вашої секретної seed-фрази ?';
  ...
  @override
  String get addNodeFailed => 'Помилка додавання ноди Sedra';
  ...
  @override
  String get addingNodeMessage => 'Будь-ласка, зачекайте, доки ми встановимо з\'єднання з нодою';
  ...
  @override
  String get checkCameraPermission => 'Будь-ласка, перевірте права доступу до камери';
  ...
  @override
  String get createPasswordFirstParagraph => 'Ви можете встановити пароль для додаткового захисту вашого гаманця.';

  @override
  String get createPasswordHint => 'Встановити пароль';

  @override
  String get createPasswordSecondParagraph => 'Пароль є опціональним, в будь-якому разі ваш гаманець буде захищений вашим PIN-кодом або біометричними даними.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Це вкладка невитраченого результату транзакції - UTXO. Усі UTXOs у вашому гаманці з\'являтимуться тут.';
  ...
  @override
  String get errorMessageCopied => 'Повідомлення про помилку скопійовано в буфер обміну';

  @override
  String get exampleCardIntro => 'Це вкладка транзакцій. Як тільки ви надішлете або отримаєте транзакцію - вона з\'явиться тут.';
  ...
  @override
  String get fingerprintSeedBackup => 'Автентифікуйтесь, щоб зробити резервну копію секретної seed-фрази.';
  ...
  @override
  String get importSecretPhraseHint => 'Будь-ласка, введіть вашу секретну seed фразу з 24-ох слів нижче.';

  @override
  String get importSecretPhraseHintCombo => 'Будь ласка, введіть свою секретну фразу з 12 або 24 слів нижче.';

  @override
  String get importSecretPhraseHintLegacy => 'Будь ласка, введіть свою секретну фразу з 12 слів нижче.';
  ...
  @override
  String get insufficientBalanceDetails => 'У вас недостатньо SDR для даної транзакції';
  ...
  @override
  String get invalidChecksumMessage => 'Будь-ласка, перевірте правильність введення вашої \nсекретної seed-фрази!';

  @override
  String get invalidKpubMessage => 'Будь ласка, перевірте правильність введення вашого розширеного публічного ключа!';
  ...
  @override
  String get sedraDevFund => 'Фонд розвитку Sedra';

  @override
  String get sedracoinWallet => 'Гаманець SedraCoin';
  ...
  @override
  String get logoutDialogContent => 'Ви впевнені, що хочете вийти з цього гаманця?';
  ...
  @override
  String get nodeDeleteTitle => 'Видалити конфігурацію ноди Sedra?';
  ...
  @override
  String get nodesSheetTitle => 'Ноди Sedra';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Вам більше не знадобиться пароль, щоб відкрити цей гаманець.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Цей пароль буде необхідним, щоб відкрити даний гаманець.';

  @override
  String get passwordsDontMatch => 'Паролі не співпадають';

  @override
  String get pasteMnemonicError => 'Вміст буфера обміну не є дійсною секретною seed-фразою';
  ...
  @override
  String get pinSeedBackup => 'Введіть PIN-код, щоб створити резервну копію секретної seed-фрази';
  ...
  @override
  String get qrInvalidSeed => 'QR-код не містить правильної секретної seed-фрази або приватного ключа';

  @override
  String get qrMnemonicError => 'QR-код не містить правильної секретної seed-фрази';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Авторизуйтесь, щоб видалити гаманець';

  @override
  String get removeWalletDetail => 'Видалення цього гаманця призведе до видалення секретної seed-фрази та всіх даних, пов\'язаних з гаманцем, з цього пристрою. Якщо ви не збережете резервну копію секретної seed-фрази - ви більше ніколи не зможете отримати доступ до своїх коштів.';

  @override
  String get removeWalletPinMessage => 'Введіть PIN-код для видалення гаманця';

  @override
  String get removeWalletReassurance => 'До тих пір, допоки ви створили та зберігаєте резервну копію секретної seed-фрази у безпечному місці - вам немає про що хвилюватися.';

  @override
  String get requireAPasswordToOpenHeader => 'Вимагати пароль, щоб відкрити цей гаманець?';
  ...
  @override
  String get secretInfo => 'На наступному екрані ви побачите свою секретну seed-фразу. Це пароль для доступу до ваших коштів. Надзвичайно важливо, щоб ви створили його резервну копію і ніколи нікому її не повідомляли.';
  ...
  @override
  String get secretWarning => 'Якщо ви втратите ваш пристрій або видалите додаток, вам обов\'язково та неминуче знадобиться ваша секретна seed-фраза, щоб відновити кошти!';
  ...
  @override
  String get sendTxProgressDescription => 'Будь-ласка, зачекайте, поки транзакція буде надіслана';
  ...
  @override
  String get sentTo => 'Надіслано до';
  ...
  @override
  String get shareSedraCoin => 'Поділитися SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Спробуйте гаманець SedraCoin';

  @override
  String get shareSedraCoinText => 'Спробуйте SedraCoin - мобільний гаманець Sedra.\nВебсайт - sedracoin.com';
  ...
  @override
  String get tooManyFailedAttempts => 'Занадто багато невдалих спроб розблокування.';
  ...
  String transferComplete(String amount) {
    return '$amount SDR успішно перераховано до вашого гаманця SedraCoin. \n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Виявлено гаманець з балансом $amount SDR.';
  }

  @override
  String get transferConfirmInfoSecond => 'Натисніть \"Підтвердити\" для переказу коштів.\n';

  @override
  String get transferConfirmInfoThird => 'Виконання переказу може зайняти кілька секунд.';

  @override
  String get transferError => 'Під час переказу сталася помилка. Будь-ласка, спробуйте пізніше.';
  ...
  String transferIntro(String button) {
    return 'Цей процес перенесе кошти з паперового гаманця у ваш гаманець SedraCoin.\n\nНатисніть кнопку \"$button\", щоб почати.';
  }
  ...
  @override
  String get transferNoFunds => 'Ця seed-фраза не містить SDR на балансі.';

  @override
  String get transferQrScanError => 'Цей QR-код не містить правильної seed-фрази.';

  @override
  String get transferQrScanHint => 'Сканувати seed-фразу \nSedra або приватний ключ';
  ...
  String welcomeMessage(String version) {
    return 'Ласкаво просимо!\n\nЦе версія $version SedraCoin - мобільного гаманця Sedra.';
  }

  @override
  String get welcomeText => 'Вітаємо в SedraCoin. Щоб розпочати, створіть новий гаманець або імпортуйте існуючий.';
  ...
  @override
  String get sedraUriInvalid => 'Невірний URI Sedra';
  ...
  @override
  String get addressFilterDialogOptionNonZeroBalances => 'Переглянути адреси з балансом';

  @override
  String get importOption24WordsTitle => 'Імпортувати секретну фразу з 24 слів';

  @override
  String get importOption24WordsDescription => 'Сумісний з консольним гаманцем CLI та Ledger';
  ...
  @override
  String get importOptionKpubTitle => 'Імпортувати гаманець тільки для перегладу';

  @override
  String get importOptionKpubDescription => 'Контролюйте баланс і транзакції гаманця за допомогою розширеного публічного ключа';

  @override
  String get importKpub => 'Імпортувати гаманець тільки для перегладу';

  @override
  String get importKpubHint => 'Будь ласка, введіть ваш розширений публічний ключ.';

  @override
  String get importKpubClipboardError => 'Вміст буфера обміну не є дійсним розширеним публічним ключем';

  @override
  String get importKpubQrCodeError => 'QR-код не містить дійсного розширеного публічного ключа';

  @override
  String get importKpubInvalidMessage => 'Будь ласка, перевірте, чи ваш розширений публічний ключ введено коректно!';
  ...
  @override
  String get hintAddressListEmpty => 'Перевірте фільтр адрес у верхньому правому кутку';
