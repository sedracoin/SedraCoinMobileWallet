...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'మీరు మీ రహస్య పదబంధం ని బ్యాకప్ చేశారని మీరు ఖచ్చితంగా అనుకుంటున్నారా?';
  ...
  @override
  String get addNodeFailed => 'sedra నోడ్  జోడించడంలో విఫలమైంది';
  ...
  @override
  String get addingNodeMessage => 'node సంప్రదిస్తున్నప్పుడు దయచేసి వేచి ఉండండి';
  ...
  @override
  String get createPasswordFirstParagraph => 'మీ వాలెట్‌కు అదనపు భద్రతను జోడించడానికి మీరు పాస్‌వర్డ్‌ను సృష్టించవచ్చు.';

  @override
  String get createPasswordHint => 'ఒక పాస్వర్డ్ను సృష్టించండి';

  @override
  String get createPasswordSecondParagraph => 'పాస్‌వర్డ్ ఐచ్ఛికం మరియు మీ వాలెట్ మీ పిన్ లేదా బయోమెట్రిక్‌లతో సంబంధం లేకుండా రక్షించబడుతుంది.';
  ...
  @override
  String get emptyCardIntroUtxos => 'ఇది UTXOs ట్యాబ్. మీ వాలెట్‌లోని అన్ని UTXOలు ఇక్కడ కనిపిస్తాయి';
  ...
  @override
  String get encryptionFailedError => 'వాలెట్ పాస్‌వర్డ్‌ని సెట్ చేయడంలో విఫలమైంది';
  ...
  @override
  String get errorMessageCopied => 'లోపం సందేశం క్లిప్‌బోర్డ్‌కి కాపీ చేయబడింది';

  @override
  String get exampleCardIntro => 'ఇది లావాదేవీల ట్యాబ్. మీరు లావాదేవీని పంపిన తర్వాత లేదా స్వీకరించిన తర్వాత, అది ఇక్కడ చూపబడుతుంది.';
  ...
  @override
  String get fingerprintSeedBackup => 'బ్యాకప్ రహస్య పదబంధానికి ప్రమాణీకరించండి';
  ...
  @override
  String get importSecretPhraseHint => 'దయచేసి మీ 24 పదాల రహస్య పదబంధాన్ని దిగువన నమోదు చేయండి.';

  @override
  String get importSecretPhraseHintCombo => 'దయచేసి మీ 12 లేదా 24 పదాల రహస్య పదబంధాన్ని దిగువన నమోదు చేయండి.';

  @override
  String get importSecretPhraseHintLegacy => 'దయచేసి మీ 12 పదాల రహస్య పదబంధాన్ని దిగువన నమోదు చేయండి.';
  ...
  @override
  String get insufficientBalanceDetails => 'ఈ లావాదేవీ కోసం మీ వద్ద తగినంత SDR లేదు';
  ...
  @override
  String get invalidChecksumMessage => 'దయచేసి మీ రహస్య పదబంధాన్ని తనిఖీ చేయండి\n సరిగ్గా నమోదు చేయబడింది!!';

  @override
  String get invalidKpubMessage => 'దయచేసి మీ పొడిగించిన పబ్లిక్ కీ సరిగ్గా నమోదు చేయబడిందో లేదో తనిఖీ చేయండి!';
  ...
  @override
  String get sedraDevFund => 'కస్పా Dev ఫండ్';

  @override
  String get sedracoinWallet => 'కాస్పియం వాలెట్';
  ...
  @override
  String get logoutDialogContent => 'మీరు ఖచ్చితంగా ఈ వాలెట్ నుండి లాగ్ అవుట్ చేయాలనుకుంటున్నారా?';
  ...
  @override
  String get nodeAddress => 'sedra నోడ్';

  @override
  String get nodeDeleteMessage => 'మీరు తొలగించాలనుకుంటున్నారా ఖచ్చితంగా?';

  @override
  String get nodeDeleteTitle => 'Sedra నోడ్ కాన్ఫిగర్‌ని తొలగించాలా?';
  ...
  @override
  String get nodesSheetTitle => 'Sedra నోడ్స్';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'ఈ వాలెట్‌ని తెరవడానికి మీకు పాస్‌వర్డ్ అవసరం లేదు.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'ఈ వాలెట్‌ని తెరవడానికి ఈ పాస్‌వర్డ్ అవసరం.';

  @override
  String get passwordsDontMatch => 'గుత్త పదములు సరి పోవట్లేదు';

  @override
  String get pasteMnemonicError => 'క్లిప్‌బోర్డ్ కంటెంట్ చెల్లుబాటు అయ్యే రహస్య పదబంధం కాదు';
  ...
  @override
  String get pinSeedBackup => 'రహస్య పదబంధాన్ని బ్యాకప్ చేయడానికి పిన్‌ని నమోదు చేయండి';
  ...
  @override
  String get qrInvalidAddress => 'QR కోడ్ చెల్లుబాటు అయ్యే చిరునామాను కలిగి లేదు';

  @override
  String get qrInvalidSeed => 'QR కోడ్ చెల్లుబాటు అయ్యే Seed లేదా ప్రైవేట్ కీని కలిగి ఉండదు';

  @override
  String get qrMnemonicError => 'QR కోడ్ చెల్లుబాటు అయ్యే రహస్య పదబంధాన్ని కలిగి లేదు';
  ...
  @override
  String get removeWalletBiometricsMessage => 'వాలెట్‌ని తీసివేయడానికి ప్రమాణీకరించండి';

  @override
  String get removeWalletDetail => 'ఈ వాలెట్‌ని తీసివేయడం వలన ఈ పరికరం నుండి రహస్య పదబంధాన్ని మరియు మొత్తం వాలెట్-సంబంధిత డేటా తీసివేయబడుతుంది. రహస్య పదబంధాన్ని బ్యాకప్ చేయకపోతే, మీరు మీ నిధులను మళ్లీ యాక్సెస్ చేయలేరు.';

  @override
  String get removeWalletPinMessage => 'వాలెట్‌ని తీసివేయడానికి పిన్‌ను నమోదు చేయండి';

  @override
  String get removeWalletReassurance => 'మీరు రహస్య పదబంధాన్ని బ్యాకప్ చేసినంత కాలం మీరు చింతించాల్సిన పనిలేదు.';

  @override
  String get requireAPasswordToOpenHeader => 'ఈ వాలెట్‌ని తెరవడానికి పాస్‌వర్డ్ కావాలా?';
  ...
  @override
  String get secretInfo => 'తదుపరి స్క్రీన్‌లో, మీరు మీ రహస్య పదబంధాన్ని చూస్తారు. ఇది మీ నిధులను యాక్సెస్ చేయడానికి పాస్‌వర్డ్. మీరు దీన్ని బ్యాకప్ చేయడం మరియు ఎవరితోనూ భాగస్వామ్యం చేయకపోవడం చాలా ముఖ్యం.';
  ...
  @override
  String get secretWarning => 'మీరు మీ పరికరాన్ని పోగొట్టుకున్నా లేదా అప్లికేషన్‌ను అన్‌ఇన్‌స్టాల్ చేసినా, మీ నిధులను తిరిగి పొందడానికి మీకు మీ రహస్య పదబంధం అవసరం!';
  ...
  @override
  String get sendTxProgressDescription => 'లావాదేవీ పంపబడే వరకు దయచేసి వేచి ఉండండి';
  ...
  @override
  String get shareSedraCoin => 'కాస్పియం యాప్‌ను భాగస్వామ్యం చేయండి';

  @override
  String get shareSedraCoinSubject => 'కాస్పియం వాలెట్‌ని తనిఖీ చేయండి';

  @override
  String get shareSedraCoinText => 'కాస్పియం - Sedra మొబైల్ వాలెట్‌ని తనిఖీ చేయండి.\nవెబ్సైట్ - sedracoin.com';
  ...
  @override
  String get tooManyFailedAttempts => 'చాలా ఎక్కువ అన్‌లాక్ ప్రయత్నాలు విఫలమయ్యాయి.';
  ...
  String transferComplete(String amount) {
    return '$amount SDR మీ కాస్పియం వాలెట్కి విజయవంతంగా బదిలీ చేయబడింది.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount SDR బ్యాలెన్స్ ఉన్న వాలెట్ కనుగొనబడింది.';
  }

  @override
  String get transferConfirmInfoSecond => 'నిధులను బదిలీ చేయడానికి నిర్ధారించు నొక్కండి.\n';

  @override
  String get transferConfirmInfoThird => 'బదిలీ పూర్తి కావడానికి కొన్ని సెకన్లు పట్టవచ్చు.';

  @override
  String get transferError => 'బదిలీ సమయంలో లోపం సంభవించింది. దయచేసి తర్వాత మళ్లీ ప్రయత్నించండి.';
  ...
  @override
  String get transferNoFunds => 'ఈ Seedలో SDR ఏదీ లేదు';

  @override
  String get transferQrScanError => 'ఈ QR కోడ్‌లో చెల్లుబాటు అయ్యే Seed లేదు.';

  @override
  String get transferQrScanHint => 'స్కాన్ చేయండి Sedra\nSeed లేదా ప్రైవేట్ కీ';
  ...
  @override
  String get walletSetupAddressDiscovery => 'చిరునామా డిస్కవరీని అమలు చేస్తోంది';
  ...
  String welcomeMessage(String version) {
    return 'స్వాగతం!\n\nఇది కాస్పియం యొక్క వెర్షన్ $version - Sedra కోసం మొబైల్ వాలెట్';
  }

  @override
  String get welcomeText => 'కాస్పియంకు స్వాగతం. ప్రారంభించడానికి, మీరు కొత్త వాలెట్‌ని సృష్టించవచ్చు లేదా ఇప్పటికే ఉన్న దాన్ని దిగుమతి చేసుకోవచ్చు.';
  ...
  String xMinutes(int minutes) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      minutes,
      locale: localeName,
      other: '$minutesString నిమిషం',
      one: '1 నిమిషం',
    );
    return 'తర్వాత $_temp0 ';
  }
  ...
  @override
  String get sedraUriInvalid => 'చెల్లని Sedra URI';
  ...
  @override
  String get scanFailedMessage => 'స్కాన్ విఫలమైంది, దయచేసి తర్వాత మళ్లీ ప్రయత్నించండి';
  ...
  @override
  String get addressFilterDialogOptionAllAddresses => 'అన్ని చిరునామాలను వీక్షించండి';

  @override
  String get addressFilterDialogOptionNonZeroBalances => 'బ్యాలెన్స్‌తో చిరునామాలను వీక్షించండి';

  @override
  String get importOption24WordsTitle => '24 పదాల రహస్య పదబంధాన్ని దిగుమతి చేయండి';

  @override
  String get importOption24WordsDescription => 'Cli Wallet మరియు లెడ్జర్‌తో అనుకూలమైనది';

  @override
  String get importOption12WordsTitle => '12 పదాల రహస్య పదబంధాన్ని దిగుమతి చేయండి';

  @override
  String get importOption12WordsDescription => 'వెబ్ వాలెట్ మరియు KDXతో అనుకూలమైనది';

  @override
  String get importOptionKpubTitle => 'వాచ్ మాత్రమే వాలెట్‌ని దిగుమతి చేయండి';

  @override
  String get importOptionKpubDescription => 'విస్తరించిన పబ్లిక్ కీని ఉపయోగించి వాలెట్ బ్యాలెన్స్ మరియు లావాదేవీలను పర్యవేక్షించండి';

  @override
  String get importKpub => 'వాచ్ మాత్రమే వాలెట్‌ని దిగుమతి చేయండి';

  @override
  String get importKpubHint => 'దయచేసి మీ విస్తరించిన పబ్లిక్ కీని నమోదు చేయండి.';

  @override
  String get importKpubClipboardError => 'క్లిప్‌బోర్డ్ కంటెంట్ చెల్లుబాటు అయ్యే పొడిగించిన పబ్లిక్ కీ కాదు';

  @override
  String get importKpubQrCodeError => 'QR కోడ్ చెల్లుబాటు అయ్యే పొడిగించిన పబ్లిక్ కీని కలిగి ఉండదు';

  @override
  String get importKpubInvalidMessage => 'దయచేసి మీ పొడిగించిన పబ్లిక్ కీ సరిగ్గా నమోదు చేయబడిందో లేదో తనిఖీ చేయండి!';

  @override
  String get receiveAddressListEmpty => 'స్వీకరించే చిరునామా జాబితా ఖాళీగా ఉంది';

  @override
  String get changeAddressListEmpty => 'చిరునామా మార్పు జాబితా ఖాళీగా ఉంది';

  @override
  String get hintAddressListEmpty => 'ఎగువ కుడి మూలలో నుండి చిరునామా ఫిల్టర్‌ని తనిఖీ చేయండి';
