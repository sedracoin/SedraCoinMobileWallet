...
class AppLocalizationsSq extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Jeni i sigurt që e keni ruajtur frazën tuaj sekrete?';
  ...
  @override
  String get addNodeFailed => 'Shtimi i nyjes Sedra dështoi';
  ...
  @override
  String get createPasswordFirstParagraph => 'Ju mund të krijoni një fjalëkalim për të shtuar siguri shtesë në portofolin tuaj.';

  @override
  String get createPasswordHint => 'Krijo një fjalëkalim';

  @override
  String get createPasswordSecondParagraph => 'Fjalëkalimi është opsional dhe kuleta juaj do të mbrohet me kodin PIN ose biometrikë pavarësisht.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Kjo është skeda UTXOs. Të gjitha UTXO-të në portofolin tuaj do të shfaqen këtu';
  ...
  @override
  String get encryptionFailedError => 'Vendosja e fjalëkalimit të portofolit dështoi';
  ...
  @override
  String get exampleCardIntro => 'Kjo është skeda e transaksioneve. Pasi të dërgoni ose merrni një transaksion, ai do të shfaqet këtu.';
  ...
  @override
  String get fingerprintSeedBackup => 'Vërtetoni për të ruajtur frazën sekrete.';
  ...
  @override
  String get importSecretPhraseHint => 'Ju lutemi shkruani frazën tuaj sekrete prej 24 fjalësh më poshtë.';
  ...
  @override
  String get insufficientBalanceDetails => 'Nuk keni mjaftueshëm SDR për këtë transaksion';
  ...
  @override
  String get invalidChecksumMessage => 'Ju lutemi kontrolloni që fraza juaj sekrete\nështë futur saktë!';
  ...
  @override
  String get sedraDevFund => 'Fondi i Dev te Sedra';

  @override
  String get sedracoinWallet => 'Portofoli i SedraCoinit';
  ...
  @override
  String get logoutDialogContent => 'Jeni i sigurt që dëshironi të dilni nga ky portofol?';
  ...
  @override
  String get nodeAddress => 'Nyje Sedra';

  @override
  String get nodeDeleteMessage => 'Jeni i sigurt që dëshironi ta fshini?';

  @override
  String get nodeDeleteTitle => 'Të fshihet konfigurimi i Nyjes Sedra?';
  ...
  @override
  String get nodesSheetTitle => 'Nyjet Sedra';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Nuk do t\'ju duhet një fjalëkalim për të hapur këtë portofol.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Ky fjalëkalim do të kërkohet për të hapur këtë portofol.';

  @override
  String get passwordsDontMatch => 'Fjalëkalimet nuk përputhen';

  @override
  String get pasteMnemonicError => 'Përmbajtja e kujtesës nuk është një frazë e vlefshme sekrete';
  ...
  @override
  String get qrInvalidSeed => 'Kodi QR nuk përmban një seed të vlefshme ose çelës privat';

  @override
  String get qrMnemonicError => 'Kodi QR nuk përmban një frazë të vlefshme sekrete';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Autentifikohu për të hequr portofolin';

  @override
  String get removeWalletDetail => 'Heqja e këtij portofoli do të heqë frazën sekrete dhe të gjitha të dhënat e lidhura me portofolin nga kjo pajisje. Nëse Fraza Sekrete nuk është e rezervuar, nuk do të mund të përdorni më kurrë fondet tuaja.';

  @override
  String get removeWalletPinMessage => 'Fut kodin PIN për të hequr portofolin';

  @override
  String get removeWalletReassurance => 'Për sa kohë që e keni ruajtur Frazën Sekrete, nuk keni asgjë për t\'u shqetësuar.';

  @override
  String get requireAPasswordToOpenHeader => 'Kërkohet një fjalëkalim për të hapur këtë portofol?';
  ...
  @override
  String get secretInfo => 'Në ekranin tjetër, do të shihni frazën tuaj sekrete. Është një fjalëkalim për të hyrë në fondet tuaja. Është thelbësore që ta mbështesni atë dhe të mos e ndani kurrë me askënd.';
  ...
  @override
  String get secretWarning => 'Nëse humbni pajisjen tuaj ose çinstaloni aplikacionin, do t\'ju duhet fraza juaj sekrete për të rikuperuar fondet tuaja!';
  ...
  @override
  String get sendTxProgressDescription => 'Ju lutemi prisni derisa transaksioni të dërgohet';
  ...
  @override
  String get shareSedraCoin => 'Shpërnda SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Shikoni Portofolin SedraCoin';

  @override
  String get shareSedraCoinText => 'Shikoni SedraCoin - Sedra Mobile Wallet.\nFaqja e internetit - sedracoin.com';
  ...
  @override
  String get tooManyFailedAttempts => 'Shumë përpjekje të dështuara për shkyçje.';
  ...
  String transferComplete(String amount) {
    return '$amount SDR u transferua me sukses në portofolin tuaj SedraCoin.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Është zbuluar një portofol me një bilanc prej $amount SDR.';
  }

  @override
  String get transferConfirmInfoSecond => 'Prekni konfirmoni për të transferuar fondet.\n';

  @override
  String get transferConfirmInfoThird => 'Transferimi mund të marrë disa sekonda për të përfunduar.';

  @override
  String get transferError => 'Ka ndodhur një gabim gjatë transferimit. Ju lutemi provoni përsëri më vonë.';
  ...
  String transferIntro(String button) {
    return 'Ky proces do të transferojë fondet nga një portofol letre në portofolin tuaj SedraCoin.\n\nPrekni butonin \"$button\" për të filluar.';
  }
  ...
  @override
  String get transferNoFunds => 'Ky seed nuk ka asnjë SDR mbi të';

  @override
  String get transferQrScanError => 'Ky kod QR nuk përmban një seed të vlefshme.';

  @override
  String get transferQrScanHint => 'Skanoni një seed Sedra\n ose çelës privat';
  ...
  String welcomeMessage(String version) {
    return 'Mirë se vini!\n\nKy është versioni $version i SedraCoin - portofoli celular për Sedra';
  }

  @override
  String get welcomeText => 'Mirë se vini në SedraCoin. Për të filluar, mund të krijoni një portofol të ri ose të importoni një ekzistues.';
