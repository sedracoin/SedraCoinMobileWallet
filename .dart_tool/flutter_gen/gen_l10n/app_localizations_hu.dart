...
class AppLocalizationsHu extends AppLocalizations {
  ...
  @override
  String get addNodeFailed => 'Sedra csomópont hozzáadása sikertelen';
  ...
  @override
  String get addingNodeMessage => 'Kérlek várj, kapcsolatfelvétel a csomóponttal... ';
  ...
  @override
  String get addressMising => 'Adj meg egy Sedra címet';
  ...
  @override
  String get createPasswordFirstParagraph => 'Megadhatsz egy jelszót, amivel SedraCoin tárcád megnyitását védheted. A biztonság mértéke a jelszó erősségétől függ.';

  @override
  String get createPasswordHint => 'Írd be a jelszót';

  @override
  String get createPasswordSecondParagraph => 'A jelszó nem kötelező, a tárcához való hozzáférés PIN kód használatával, vagy biometrikus azonosítással biztosítható.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Itt találod majd a tárcába érkezett utalások maradékait.';
  ...
  @override
  String get exampleCardIntro => 'Itt találod majd a tárcához tartozó tranzakciókat.';
  ...
  @override
  String get fingerprintSeedBackup => 'Erősítsd meg, hogy szeretnéd elmenteni a Seed Phrase-t.';
  ...
  @override
  String get importSecretPhraseHintCombo => 'Add meg a 12, vagy 24 szóból álló Seed Phrase-t.';

  @override
  String get importSecretPhraseHintLegacy => 'Add meg a 12 szóból álló Seed Phrase-t.';

  @override
  String get importWallet => 'SDR tárca importálása';
  ...
  @override
  String get insufficientBalanceDetails => 'Nincs elegendő SDR a tranzakcióhoz';
  ...
  @override
  String get invalidChecksumMessage => 'Ellenőrizd a Seed Phrase-t,\nhogy helyesen legyen megadva!';

  @override
  String get invalidKpubMessage => 'Ellenőrizd, hogy a kibővített nyilvános kulcs helyesen van-e megadva!';
  ...
  @override
  String get sedraDevFund => 'Sedra fejlesztői alap';

  @override
  String get sedracoinWallet => 'SedraCoin tárca';
  ...
  @override
  String get logoutDialogContent => 'Szeretnél kijelentkezni ebből a SDR tárcából?';
  ...
  @override
  String get nodeAddress => 'Sedra csomópont';

  @override
  String get nodeDeleteMessage => 'Biztos, hogy TÖRÖLNI akarod?';

  @override
  String get nodeDeleteTitle => 'Törlöd a Sedra csomópont beállítását?';
  ...
  @override
  String get nodesSheetTitle => 'Sedra csomópontok';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Kikapcsolás után nincs szükség jelszó megadásra a pénztárca megnyitásához.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Ezzel a jelszóval tudod majd a tárcát megnyitni.';

  @override
  String get passwordsDontMatch => 'A jelszavak nem egyeznek';

  @override
  String get pasteMnemonicError => 'A vágólap nem tartalmaz érvényes Seed Phrase-t.';
  ...
  @override
  String get qrInvalidSeed => 'A QR-kód nem tartalmaz érvényes Seed Phrase-t, vagy privát kulcsot';

  @override
  String get qrMnemonicError => 'A QR-kód nem tartalmaz érvényes Seed Phrase-t.';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Hitelesítés a tárca eltávolításához';

  @override
  String get removeWalletDetail => 'A SedraCoin tárca eltávolításával eltávolítod a Seed Phrase-t és a tárcával kapcsolatos összes adatot erről az eszközről. Amennyiben a Seed Phrase-ről NEM készült másolat, SOHA többé nem fogsz hozzáférni a tárcádhoz.';

  @override
  String get removeWalletPinMessage => 'PIN megadása a tárca eltávolításához';

  @override
  String get removeWalletReassurance => 'Amennyiben elmentetted a Seed Phrase-t, akkor nincs miért aggódnod, mert annak a használatával, bármikor vissza tudsz lépni a tárcádba. ';

  @override
  String get requireAPasswordToOpenHeader => 'Szeretnél jelszót használni a megnyitáshoz?    ';
  ...
  @override
  String get secretInfo => 'A következő képernyőn látni fogod a Seed Phrase-t. Ez a 24 szó az, amivel mindig el fogod tudni érni a tárcád. NAGYON fontos, hogy  másolatot készíts róla -ÍRD LE- és soha ne oszd meg senkivel.  ';
  ...
  @override
  String get secretWarning => 'Ha elveszted ezt az eszközt, vagy eltávolítod az alkalmazást, szükség lesz a Seed Phrase-re a SedraCoin tárcád ismételt eléréséhez. ';
  ...
  @override
  String get sendTxProgressDescription => 'Kérjük várj, amíg a tranzakció elküldésre kerül';
  ...
  @override
  String get sentTo => 'Elküldve ide';
  ...
  @override
  String get shareSedraCoin => 'SedraCoin megosztása';

  @override
  String get shareSedraCoinSubject => 'Nézd meg a SedraCoin tárcát';

  @override
  String get shareSedraCoinText => 'Próbáld ki a SedraCoinot, a Sedra mobiltárcáját!\nWebsite - sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR sikeresen átkerült a SedraCoin tárcádba.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount SDR egyenlegű tárca észlelve.';
  }

  @override
  String get transferConfirmInfoSecond => 'Koppints az átutalás megerősítéséhez.\n';

  @override
  String get transferConfirmInfoThird => 'Az átvitel néhány másodpercig tarthat.';

  @override
  String get transferError => 'Hiba történt az átvitel során. Kérlek, próbáld újra később.';
  ...
  String transferIntro(String button) {
    return 'Ez a folyamat egy papírtárcán lévő SDR-t a SedraCoin tárcába helyezi át.\n\nA kezdéshez érintsd meg a \"$button\" gombot.';
  }
  ...
  @override
  String get transferNoFunds => 'A Seed Phrase-hez tartózó tárcában nincs SDR';

  @override
  String get transferQrScanError => 'Ez a QR-kód nem tartalmaz érvényes Seed Phrase-t';

  @override
  String get transferQrScanHint => 'Olvass be Sedra\nSeed Phrase-t, vagy privát kulcsot';
  ...
  @override
  String get unlockBiometrics => 'Hitelesítés szükséges a SedraCoinba való bejelentkezéshez';
  ...
  @override
  String get walletsTitle => 'SDR tárcák';
  ...
  String welcomeMessage(String version) {
    return 'Légy üdvözölve!\n\nEz a Sedra mobiltárca $version verziója.';
  }

  @override
  String get welcomeText => 'Üdv SedraCoinban! Hozz létre egy új tárcát, vagy importálj egy meglévőt.';
  ...
  @override
  String get sedraUriInvalid => 'Helytelen Sedra URI';
  ...
  @override
  String get importOption24WordsDescription => 'Kompatibilis Cli pénztárcával és Ledger-rel ';

  @override
  String get importOption12WordsTitle => '12 szavas Secret Phrase importálása';

  @override
  String get importOption12WordsDescription => 'Kompatibilis a webes pénztárcával és KDX mentéssel.';

  @override
  String get importOptionKpubTitle => 'Tárca figyelés importálása';

  @override
  String get importOptionKpubDescription => 'Egy kibővített nyilvános kulcs segítségével nyomon követhető egy pénztárca egyenlege és tranzakciói.';
  ...
  @override
  String get importKpubClipboardError => 'A vágólap nem tartalmaz érvényes kibővített nyilvános kulcsot';

  @override
  String get importKpubQrCodeError => 'A QR kód nem tartalmaz érvényes kibővített nyilvános kulcsot';

  @override
  String get importKpubInvalidMessage => 'Ellenőrizd, hogy a kibővített nyilvános kulcs helyesen van-e megadva!';
  ...
  @override
  String get hintAddressListEmpty => 'Ellenőrizd a cím szűrőt a jobb felső sarokban';
