...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'کیا آپ کو یقین ہے کہ آپ نے اپنے خفیہ جملے کا بیک اپ لیا ہے؟';
  ...
  @override
  String get createPasswordFirstParagraph => 'آپ اپنے بٹوے میں اضافی سیکیورٹی شامل کرنے کے لیے پاس ورڈ بنا سکتے ہیں۔';

  @override
  String get createPasswordHint => 'پاس ورڈ بنائیں';

  @override
  String get createPasswordSecondParagraph => 'پاس ورڈ اختیاری ہے، اور آپ کے بٹوے کو آپ کے PIN یا بایومیٹرکس سے قطع نظر محفوظ رکھا جائے گا۔';
  ...
  @override
  String get emptyCardIntroUtxos => 'یہ UTXOs ٹیب ہے۔ آپ کے بٹوے میں موجود تمام UTXO یہاں ظاہر ہوں گے۔';
  ...
  @override
  String get exampleCardIntro => 'یہ لین دین کا ٹیب ہے۔ ایک بار جب آپ کوئی لین دین بھیجتے یا وصول کرتے ہیں، تو یہ یہاں ظاہر ہوگا۔';
  ...
  @override
  String get importSecretPhraseHint => 'براہ کرم ذیل میں اپنا 24 الفاظ کا خفیہ جملہ درج کریں۔';
  ...
  @override
  String get insufficientBalanceDetails => 'آپ کے پاس اس لین دین کے لیے کافی SDR نہیں ہے';
  ...
  @override
  String get invalidChecksumMessage => 'براہ کرم چیک کریں کہ آپ کا خفیہ جملہ   درست درج کیا گیا ہے!';
  ...
  @override
  String get sedraDevFund => 'کاسپا دیو فنڈ';

  @override
  String get sedracoinWallet => 'کاسپیم بٹوا ';
  ...
  @override
  String get logoutDialogContent => 'کیا آپ واقعی اس بٹوے سے لاگ آؤٹ کرنا چاہتے ہیں؟';
  ...
  @override
  String get nodeDeleteTitle => 'Sedra Node Config کو حذف کریں؟';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'اس بٹوے کو کھولنے کے لیے آپ کو پاس ورڈ کی ضرورت نہیں ہوگی۔';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'اس بٹوا کو کھولنے کے لیے اس پاس ورڈ کی ضرورت ہوگی۔';
  ...
  @override
  String get removeWalletBiometricsMessage => 'بٹوا کو ہٹانے کے لیے تصدیق کریں۔';

  @override
  String get removeWalletDetail => 'اس بٹوے کو ہٹانے سے اس ڈیوائس سے خفیہ جملہ اور بٹوے سے متعلق تمام ڈیٹا ہٹ جائے گا۔ اگر خفیہ جملے کا بیک اپ نہیں لیا جاتا ہے، تو آپ دوبارہ کبھی بھی اپنے فنڈز تک رسائی حاصل نہیں کر پائیں گے۔';

  @override
  String get removeWalletPinMessage => 'بٹوا کو ہٹانے کے لیے پن درج کریں۔';

  @override
  String get removeWalletReassurance => 'جب تک آپ نے خفیہ جملے کا بیک اپ لیا ہے آپ کو فکر کرنے کی کوئی ضرورت نہیں ہے۔';

  @override
  String get requireAPasswordToOpenHeader => 'اس بٹوا کو کھولنے کے لیے پاس ورڈ کی ضرورت ہے؟';
  ...
  @override
  String get secretInfo => 'اگلی اسکرین میں، آپ کو اپنا خفیہ جملہ نظر آئے گا۔ یہ آپ کے فنڈز تک رسائی کا پاس ورڈ ہے۔ یہ بہت ضروری ہے کہ آپ اس کا بیک اپ لیں اور اسے کبھی کسی کے ساتھ شیئر نہ کریں۔';
  ...
  @override
  String get secretWarning => 'اگر آپ اپنا آلہ کھو دیتے ہیں یا ایپلیکیشن ان انسٹال کرتے ہیں، تو آپ کو اپنے فنڈز کی وصولی کے لیے اپنے خفیہ جملے کی ضرورت ہوگی!';
  ...
  @override
  String get sendTxProgressDescription => 'براہ کرم ٹرانزیکشن بھیجے جانے تک انتظار کریں۔';
  ...
  @override
  String get shareSedraCoin => 'SedraCoin کا اشتراک کریں۔';

  @override
  String get shareSedraCoinSubject => 'SedraCoin Wallet چیک کریں۔';

  @override
  String get shareSedraCoinText => 'SedraCoin - Sedra Mobile Wallet  ویب سائٹ - sedracoin.com چیک کریں۔';
  ...
  String transferComplete(String amount) {
    return '$amount SDR کامیابی کے ساتھ آپ کے SedraCoin Wallet میں منتقل ہو گیا۔\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return '$amount SDR کے بیلنس والے پرس کا پتہ چلا ہے۔';
  }

  @override
  String get transferConfirmInfoSecond => 'رقوم کی منتقلی کے لیے تصدیق پر ٹیپ کریں۔\n';

  @override
  String get transferConfirmInfoThird => 'منتقلی مکمل ہونے میں کئی سیکنڈ لگ سکتے ہیں۔';

  @override
  String get transferError => 'منتقلی کے دوران ایک خرابی پیش آگئی ہے۔ براہ کرم کچھ دیر بعد کوشش کریں.';
  ...
  String transferIntro(String button) {
    return 'یہ عمل کاغذی بٹوے سے آپ کے SedraCoin والیٹ میں رقم منتقل کر دے گا۔\n\n شروع کرنے کے لیے \"$button\" بٹن کو تھپتھپائیں  ۔';
  }
  ...
  @override
  String get transferNoFunds => 'اس سیڈ پر کوئی SDR نہیں ہے۔';

  @override
  String get transferQrScanError => 'اس QR کوڈ میں درست سیڈ نہیں ہے۔';

  @override
  String get transferQrScanHint => 'Sedra سیڈ یا نجی کلید اسکین کریں۔';
  ...
  String welcomeMessage(String version) {
    return 'خوش آمدید!یہ \n\n  SedraCoin کا ورژن $version ہے - Sedra کے لیے موبائل والیٹ';
  }

  @override
  String get welcomeText => 'SedraCoin میں خوش آمدید۔ شروع کرنے کے لیے، آپ ایک نیا پرس بنا سکتے ہیں یا پہلے سے موجود کو درآمد کر سکتے ہیں۔';
