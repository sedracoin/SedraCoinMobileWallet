...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'هل أنت متأكد من أنك قمت بنسخ نسخة احتياطية من العبارة السرية أو مفتاحك الخاص؟';
  ...
  @override
  String get createPasswordFirstParagraph => 'يمكنك إنشاء كلمة مرور لإضافة أمان إلى محفظتك.\n';

  @override
  String get createPasswordHint => 'أنشئ كلمة مرور\n';

  @override
  String get createPasswordSecondParagraph => 'كلمة المرور اختيارية ، وسيتم حماية محفظتك برقم التعريف الشخصي أو القياسات الحيوية بغض النظر.\n';
  ...
  @override
  String get exampleCardIntro => 'مرحبا بكم في نتريوم. بمجرد تلقي SDR ، ستظهر المعاملات كما يلي:';
  ...
  @override
  String get importSecretPhraseHint => 'الرجاء إدخال عبارة سرية مكونة من 24 كلمة. يجب فصل كل كلمة بمسافة.';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'لن تحتاج إلى كلمة مرور لفتح  نتريم بعد الآن.\n';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'هناك حاجة إلى كلمة المرور لفتح نتريم';
  ...
  @override
  String get qrInvalidAddress => 'لا يحتوي رمز الاستجابة السريعة على وجهة صالحة\n';

  @override
  String get qrInvalidSeed => 'رمز الاستجابة السريعة لا يحتوي على مفتاح خاص صحيح';

  @override
  String get qrMnemonicError => 'لا يحتوي رمز الاستجابة السريعة على عبارة سرية صالحة';
  ...
  @override
  String get secretInfo => 'في الشاشة التالية ، سترى العبارة السرية الخاصة بك. إنها كلمة مرور للوصول إلى أموالك. من الأهمية أن تقوم بنسخه احتياطيًا وأن لا تشاركه أبدًا مع أي شخص.';
  ...
  @override
  String get secretWarning => 'إذا فقدت جهازك أو قمت بحذف التطبيق ، فستحتاج إلى عباراتك السرية أو بمفتاح سري لاسترداد أموالك!';
  ...
  @override
  String get sentTo => 'تم الإرسال إلى';
  ...
  String transferComplete(String amount) {
    return 'تم تحويل $amount SDR إلى محفظة نتريوم.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'تم كشف محفظة برصيد $amount SDR.\n';
  }
  ...
  @override
  String get transferError => 'لقد حدث خطأ أثناء النقل. الرجاء إعادة المحاولة في وقت لاحق.';
  ...
  @override
  String get transferNoFunds => 'هذا المفتاح الخاص لا يحتوي على SDR';

  @override
  String get transferQrScanError => 'لا يحتوي رمز الاستجابة السريعة على مفتاح خاص صحيح.';
  ...
  @override
  String get welcomeText => 'أهلا بك في نتريوم. لتبدأ، إحدث محفظة أو إجلب محفظة موجودة.';
