...
class AppLocalizationsHe extends AppLocalizations {
  ...
  @override
  String get createPasswordFirstParagraph => 'ניתן לבחור סיסמה כדי להוסיף אבטחה נוספת לארנק';

  @override
  String get createPasswordHint => 'צור סיסמה';

  @override
  String get createPasswordSecondParagraph => 'ניתן לדלג על בחירת הסיסמה. הארנק מאובטח על ידי הקוד הסודי או טביעת אצבע בכל מקרה.';
  ...
  @override
  String get exampleCardIntro => 'זוהי לשונית עסקאות. לאחר שתשלחו או תקבלו עסקה, היא תופיע פה.';
  ...
  @override
  String get importSecretPhraseHintCombo => 'אנא הזן את הביטוי הסודי שלך בן 12 או 24 מילים למטה';

  @override
  String get importSecretPhraseHintLegacy => 'הזן את 12 מילות הביטוי הסודי למטה ';
  ...
  @override
  String get invalidKpubMessage => 'אנא בדוק שהמפתח הציבורי המורחב שלך הוזן כראוי!';
  ...
  @override
  String get sedraDevFund => 'קרן פיתוח כספא';

  @override
  String get sedracoinWallet => 'ארנק כספיום';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'אין צורך בסיסמה לפתיחת ארנק זה';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'חייבים להשתמש בסיסמה זו לפתיחת הארנק.';
  ...
  @override
  String get secretInfo => 'המסך הבא יראה את הביטוי הסודי שלכם. זה ביטוי שמאפשר לכם גישה לכספים שלכם.\nמאוד חשוב שתשמרו את הביטוי במקום בטוח בנפרד למכשיר ושלא תשתפו אותו עם אנשים אחרים!';
  ...
  @override
  String get secretWarning => 'אם תאבדו את המכשיר או תורידו את האפליקציה מהמכשיר אתם תצטרכו להשתמש בביטוי הסודי כדי לגשת לכספים שלכם! ';
  ...
  @override
  String get shareSedraCoin => 'שתף את כספיום';

  @override
  String get shareSedraCoinSubject => 'תראו כמה מגניב כספיום';

  @override
  String get shareSedraCoinText => 'תראו את כספיום - ארנק כספא לנייד.\nאתר - sedracoin.com';
  ...
  @override
  String get welcomeText => 'ברוך הבא לכספיום. כדי להתחיל, ניתן ליצור ארנק חדש או לייבא אחד קיים.';
  ...
  @override
  String get sedraUriInvalid => 'URI של כספא לא חוקי';
  ...
  @override
  String get importOptionKpubDescription => 'עקוב אחר היתרה והעסקאות של ארנק באמצעות מפתח ציבורי מורחב';
  ...
  @override
  String get importKpubClipboardError => 'תוכן ההתעקה אינו מפתח ציבורי מורחב חוקי';

  @override
  String get importKpubQrCodeError => 'קוד QR אינו מכיל מפתח ציבורי מורחב תקין';

  @override
  String get importKpubInvalidMessage => 'אנא בדוק שהמפתח הציבורי המורחב שלך הוזן כראוי!';
  ...
  @override
  String get hintAddressListEmpty => 'בדוק את מסנן הכתובות מהפינה השמאלית העליונה';
