...
class AppLocalizationsCs extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Jste si jisti, že jste zálohovali svou tajnou frázi?';
  ...
  @override
  String get addNodeFailed => 'Přidání Sedra Uzlu selhalo';
  ...
  @override
  String get createPasswordFirstParagraph => 'Můžete si vytvořit heslo a lépe tak zabezpečit svou peněženku';

  @override
  String get createPasswordHint => 'Vytvořit heslo';

  @override
  String get createPasswordSecondParagraph => 'Heslo je volitelné a vaše peněženka bude bez ohledu na to chráněna vaším PIN kódem nebo biometrickými údaji.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Toto je záložka UTXO. Všechna UTXO ve Vaší peněžence se objeví zde';
  ...
  @override
  String get encryptionFailedError => 'Nastavení hesla k peněžence se nezdařilo';
  ...
  @override
  String get exampleCardIntro => 'Toto je záložka transakcí. Jakmile pošleš nebo obdržíš SDR, ukáže se to zde:';
  ...
  @override
  String get importSecretPhraseHint => 'Níže prosím zadejte svoji 24-slovní tajnou frázi. ';
  ...
  @override
  String get insufficientBalanceDetails => 'Nemáte dostatek SDR pro provedení této transakce';
  ...
  @override
  String get invalidChecksumMessage => 'Zkontrolujte prosím, zda je Vaše Tajná Fráze \nzadána správně!';
  ...
  @override
  String get sedraDevFund => 'Vývojářský Fond sedra';

  @override
  String get sedracoinWallet => 'Peněženka SedraCoin';
  ...
  @override
  String get logoutDialogContent => 'Opravdu se chcete odhlásit z této peněženky?';
  ...
  @override
  String get nodeAddress => 'Sedra Uzel';

  @override
  String get nodeDeleteMessage => 'Jste si jisti, že to chcete smazat?';

  @override
  String get nodeDeleteTitle => 'Smazat nastavení Sedra Uzlu?';
  ...
  @override
  String get nodesSheetTitle => 'Sedra Uzly';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Už nebudete potřebovat heslo pro otevření Peněženky.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Toto heslo bude vyžadováno k otevření Peněženky.';
  ...
  @override
  String get qrInvalidSeed => 'QR kód neobsahuje platné jádro ani soukromý klíč';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Ověřte se pro odstranění Peněženky';

  @override
  String get removeWalletDetail => 'Odstranění této peněženky odstraní tajnou frázi a všechna na peněženku vázaná data z tohoto zařízení. Pokud jste si nezálohovali tajnou frázi, už se nikdy ke svým prostředkům nedostanete.';

  @override
  String get removeWalletPinMessage => 'Zadat PIN pro Odstranění Peněženky';

  @override
  String get removeWalletReassurance => 'Pokud jste si zálohovaly tajnou frázi, nemusíte se ničeho obávat.';

  @override
  String get requireAPasswordToOpenHeader => 'Vyžadovat heslo k otevření této peněženky?';
  ...
  @override
  String get secretInfo => 'Na následující obrazovce uvidíte svoji tajnou frázi. Jedná se o heslo pro přístup k vašim finančním prostředkům. Je klíčové, abyste jej zálohovali a nikdy s nikým nesdíleli.';
  ...
  @override
  String get secretWarning => 'Pokud ztratíte zařízení nebo odinstalujete aplikaci, budete potřebovat tajnou frázi nebo jádro, abyste mohli získat zpět své prostředky!';
  ...
  @override
  String get sendTxProgressDescription => 'Prosím počkejte, než se transakce odešle';
  ...
  @override
  String get shareSedraCoin => 'Sdílet SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Vyzkoušet Peněženku SedraCoin';

  @override
  String get shareSedraCoinText => 'Vyzkoušejte SedraCoin - mobilní peněženka pro Sedra. Web - sedracoin.com';
  ...
  @override
  String get tooManyFailedAttempts => 'Příliš mnoho neúspěšných pokusů o odemknutí.';
  ...
  String transferComplete(String amount) {
    return '$amount SDR úspěšně převedeno do vaší peněženky SedraCoin. \n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Byla nalezena peněženka se zůstatkem $amount SDR. ';
  }

  @override
  String get transferConfirmInfoSecond => 'Klepněte pro potvrzení převedení prostředků.\n';

  @override
  String get transferConfirmInfoThird => 'Dokončení přenosu může trvat několik sekund.';

  @override
  String get transferError => 'Během přenosu došlo k chybě. Prosím zkuste to znovu později.';
  ...
  String transferIntro(String button) {
    return 'Tento proces přenese prostředky z papírové peněženky do vaší peněženky SedraCoin. \n\n Začněte klepnutím na tlačítko \"$button\".';
  }
  ...
  @override
  String get transferNoFunds => 'Toto jádro na sobě nemá žádné SDR ';

  @override
  String get transferQrScanError => 'Tento QR kód neobsahuje platné jádro.';

  @override
  String get transferQrScanHint => 'Naskenujte Sedra\njádro nebo soukromý klíč ';
  ...
  @override
  String get unlockBiometrics => 'Ověřte a Odemkněte SedraCoin';
  ...
  String welcomeMessage(String version) {
    return 'Vítejte!\n\nToto je verze $version SedraCoin Peněženky - mobilní peněženky pro Sedra';
  }

  @override
  String get welcomeText => 'Vítejte v SedraCoin. Nejprve můžete vytvořit novou peněženku nebo importovat stávající.';
