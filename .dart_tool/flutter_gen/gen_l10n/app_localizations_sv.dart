...
class AppLocalizationsSv extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Är du säker på att du har sparat ner din hemliga fras eller seed?';
  ...
  @override
  String get addNodeFailed => 'Misslyckades att lägga till en Sedra nod';
  ...
  @override
  String get createPasswordFirstParagraph => 'Du kan ställa in ett lösenord för att öka säkerheten av din plånbok.';

  @override
  String get createPasswordHint => 'Ställ in ett lösenord';

  @override
  String get createPasswordSecondParagraph => 'Ett lösenord är valfritt och din plånbok kommer ändå att skyddas av din PIN-kod eller av biometri.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Det här är fliken för unspent transaction outputs. Alla UTXOs i din plånbok kommer att visas här';
  ...
  @override
  String get encryptionFailedError => 'Misslyckades med att ställa in ett lösenord';
  ...
  @override
  String get exampleCardIntro => 'Det är här är fliken för transaktioner, när du har tagit emot eller skickat en transaktion så kommer den visas här. ';
  ...
  @override
  String get fingerprintSeedBackup => 'Verifiera dig för att göra en backup på din hemliga fras.';
  ...
  @override
  String get importSecretPhraseHint => 'Ange din hemliga fras på 24 ord. Varje ord ska separeras med ett mellanslag.';
  ...
  @override
  String get insufficientBalanceDetails => 'Du har inte nog med SDR för att genomföra transaktionen';
  ...
  @override
  String get invalidChecksumMessage => 'Snälla kontrollera att din hemliga fras är korrekt angiven!';
  ...
  @override
  String get sedraDevFund => 'Sedras utvecklingsfond';

  @override
  String get sedracoinWallet => 'SedraCoin plånbok';
  ...
  @override
  String get logoutDialogContent => 'Är du säker på att du vill logga ut från den här plånboken?';
  ...
  @override
  String get nodeAddress => 'Sedra nod';

  @override
  String get nodeDeleteMessage => 'Är du säker på att du vill radera?';

  @override
  String get nodeDeleteTitle => 'Radera Sedra nod konfiguration?\n';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Du kommer inte behöva ett lösenord för att öppna SedraCoin längre.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Lösenordet behövs för att öppna SedraCoin.';

  @override
  String get passwordsDontMatch => 'Lösenorden stämmer ej överens';

  @override
  String get pasteMnemonicError => 'Urklippet innehåller inte en giltig hemlig fras';
  ...
  @override
  String get pinSeedBackup => 'Ange PIN-kod för att säkerhetskopiera din hemliga fras';
  ...
  @override
  String get qrInvalidAddress => 'QR-koden innehåller inte en giltig destination';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Verifiera för att ta bort plånbok';

  @override
  String get removeWalletDetail => 'Genom att ta bort den här plånboken så kommer den hemliga frasen och all plånboksrelaterade data raderas. Om den hemliga frasen inte är tryggt förvarad så kommer du aldrig åt dina tillgångar igen.';

  @override
  String get removeWalletPinMessage => 'Skriv in PIN för att ta bort plånbok';

  @override
  String get removeWalletReassurance => 'Så länge du har säkerhetskopierat den hemliga frasen så har du inget att oroa dig över.';

  @override
  String get requireAPasswordToOpenHeader => 'Kräv lösenord för att öppna SedraCoin?';
  ...
  @override
  String get secretInfo => 'På nästa skärm kommer du att se din hemliga fras. Det är ett lösenord för att komma åt dina tillgångar. Det är viktigt att du sparar ner den och aldrig delar den med någon.';
  ...
  @override
  String get secretWarning => 'Om du tappar bort din enhet eller avinstallerar applikationen så behöver du din hemliga fras eller ditt seed för att återfå dina tillgångar!';
  ...
  @override
  String get sendTxProgressDescription => 'Vänligen vänta medans transaktionen skickas';
  ...
  @override
  String get shareSedraCoin => 'Dela SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Kolla in SedraCoin plånboken';

  @override
  String get shareSedraCoinText => 'Prova SedraCoin! Sedras mobila plånbok. Webbsida - sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR har överförts till din SedraCoin-plånbok.';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'En plånbok med ett saldo på $amount SDR har upptäckts.\n';
  }

  @override
  String get transferConfirmInfoSecond => 'Tryck på bekräfta för att överföra tillgångar.\n';

  @override
  String get transferConfirmInfoThird => 'Överföringen kan ta upp till flera sekunder att genomföras.';

  @override
  String get transferError => 'Ett fel uppstod vid överföringen. Försök igen senare.';
  ...
  String transferIntro(String button) {
    return 'Den här processen kommer att överföra tillgångar från en pappersplånbok till din SedraCoin-plånbok.\n\nTryck på \"$button\" knappen för att starta.';
  }
  ...
  @override
  String get transferNoFunds => 'Detta seed innehåller inga SDR.';

  @override
  String get transferQrScanError => 'Denna QR-kod innehåller inget giltigt seed.';

  @override
  String get transferQrScanHint => 'Skanna en Sedra \nseed eller en privat nyckel';
  ...
  @override
  String get unlockBiometrics => 'Verifiera för att låsa upp SedraCoin';

  @override
  String get unlockPin => 'Ange PIN för att låsa upp SedraCoin';
  ...
  String welcomeMessage(String version) {
    return 'Välkommen! Det här är version $version för SedraCoin - den mobila appen för Sedra';
  }

  @override
  String get welcomeText => 'Välkommen till SedraCoin. För att fortsätta så behöver du skapa en ny plånbok eller importera en befintlig plånbok.';
