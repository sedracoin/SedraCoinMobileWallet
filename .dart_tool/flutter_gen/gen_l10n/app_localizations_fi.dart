...
class AppLocalizationsFi extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'Oletko varma että olet varmuuskopioinut turvasanasi?';
  ...
  @override
  String get addNodeFailed => 'Sedra-solmun lisääminen epäonnistui';
  ...
  @override
  String get createPasswordFirstParagraph => 'Voit luoda salasanan lisätäksesi turvallisuutta lompakollesi.';

  @override
  String get createPasswordHint => 'Luo salasana';

  @override
  String get createPasswordSecondParagraph => 'Salasana ei ole pakollinen, ja lompakkosi suojataan PIN-koodilla tai biometriikalla joka tapauksessa.';
  ...
  @override
  String get emptyCardIntroUtxos => 'Tämä on UTXO-välilehti. Kaikki lompakkosi UTXO:t näkyvät täällä';
  ...
  @override
  String get exampleCardIntro => 'Tämä on tapahtumien välilehti. Kun olet lähettänyt tai vastaanottanut tapahtumia, ne näkyvät täällä.';
  ...
  @override
  String get fingerprintSeedBackup => 'Tunnistaudu varmuuskopioidaksesi turvasanat';
  ...
  @override
  String get insufficientBalanceDetails => 'Sinulla ei ole tapahtuman vaatimaa SDR-määrää';
  ...
  @override
  String get invalidChecksumMessage => 'Tarkista että turvasanat\n ovat syötetty oikein!';

  @override
  String get invalidKpubMessage => 'Varmista että laajennettu julkinen avaimesi on syötetty oikein!';

  @override
  String get invalidDestinationAddress => 'Vastaanottajan osoite on virheellinen';

  @override
  String get invalidPassword => 'Virheellinen salasana';

  @override
  String get sedraDevFund => 'Sedran kehitysvarat';

  @override
  String get sedracoinWallet => 'SedraCoin-lompakko';
  ...
  @override
  String get logoutDialogContent => 'Oletko varma, että haluat kirjautua ulos tästä lompakosta?';
  ...
  @override
  String get nodeAddress => 'Sedra-solmu';

  @override
  String get nodeDeleteMessage => 'Haluatko varmasti poistaa?';

  @override
  String get nodeDeleteTitle => 'Poista Sedra-solmun asetukset?';
  ...
  @override
  String get nodesSheetTitle => 'Sedra-solmut';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'Et tule tarvitsemaan salasanaa avataksesi tätä lompakkoa.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'Tämä salasana vaaditaan tämän lompakon avaamiseen.';
  ...
  @override
  String get qrInvalidSeed => 'QR-koodi ei sisällä validia seediä tai yksityistä avainta';
  ...
  @override
  String get removeWalletBiometricsMessage => 'Tunnistaudu poistaaksesi lompakon';

  @override
  String get removeWalletDetail => 'Poistamalla tämän lompakon tästä laitteesta poistuvat myös turvasanat ja kaikki lompakon tiedot. Jos turvasanoja ei ole varmuuskopioitu, et tule koskaan pääsemään käsiksi varoihin uudestaan.';

  @override
  String get removeWalletPinMessage => 'Syötä PIN-koodi poistaaksesi lompakon';

  @override
  String get removeWalletReassurance => 'Kunhan olet varmuuskopioinut turvasanasi, ei sinulla ole mitään huolta.';

  @override
  String get requireAPasswordToOpenHeader => 'Vaaditaanko salasana tämän lompakon avaamiseen?';
  ...
  @override
  String get secretInfo => 'Seuraavalla sivulla näet turvasanasi. Ne ovat salasanasi päästäksesi käsiksi varoihisi. On todella tärkeää, että varmuuskopioit ne etkä ikinä jaa niitä kenellekään.';
  ...
  @override
  String get secretWarning => 'Mikäli hävität laitteesi tai poistat sovelluksen, tarvitset turvasanasi palauttaaksesi varasi!';
  ...
  @override
  String get sentTo => 'Lähetä vastaanottajalle';
  ...
  @override
  String get shareSedraCoin => 'Jaa SedraCoin';

  @override
  String get shareSedraCoinSubject => 'Käy tutustumassa SedraCoin-lompakkoon';

  @override
  String get shareSedraCoinText => 'Käy tutustumassa SedraCoiniin — Sedra-mobiililompakko.\nVerkkosivusto — sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR onnistuneesti siirretty SedraCoin-lompakkoosi.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'Lompakko, joka sisältää $amount SDR havaittu.';
  }

  @override
  String get transferConfirmInfoSecond => 'Hyväksy varojen siirto napauttamalla Vahvista.\n';

  @override
  String get transferConfirmInfoThird => 'Siirto saattaa kestää muutaman sekunnin.';

  @override
  String get transferError => 'Siirrossa tapahtui virhe. Yritä myöhemmin uudelleen.';
  ...
  String transferIntro(String button) {
    return 'Tämä prosessi siirtää varat paperilompakosta SedraCoin-lompakkoosi.\n\nNapauta painiketta \"$button\" aloittaaksesi.';
  }
  ...
  @override
  String get transferNoFunds => 'Tämä seed ei pidä sisällään yhtään SDRia';

  @override
  String get transferQrScanError => 'Tämä QR-koodi ei sisällä validia seediä.';

  @override
  String get transferQrScanHint => 'Skannaa Sedra \nseed tai yksityinen avain';
  ...
  String welcomeMessage(String version) {
    return 'Tervetuloa!\n\nTämä on versio $version SedraCoinista - Mobiililompakko Sedralle';
  }

  @override
  String get welcomeText => 'Tervetuloa SedraCoiniin. Aloittaaksesi voit luoda uuden lompakon tai tuoda olemassa olevan.';
  ...
  @override
  String get sedraUriInvalid => 'Virheellinen Sedra-URI';
  ...
  @override
  String get scanFailedMessage => 'Skannaus epäonnistui, yritä uudelleen myöhemmin';
  ...
  @override
  String get addressFilterDialogOptionNonZeroBalances => 'Näytä osoitteet, joissa saldoa';

  @override
  String get importOption24WordsTitle => 'Tuo 24 turvasanaa';

  @override
  String get importOption24WordsDescription => 'Yhteensopiva Cli-lompakon ja Ledgerin kanssa';

  @override
  String get importOption12WordsTitle => 'Tuo 12 turvasanaa';

  @override
  String get importOption12WordsDescription => 'Yhteensopiva Web-lompakon ja KDX:n kanssa';

  @override
  String get importOptionKpubTitle => 'Tuo Watch-seurantalompakko';

  @override
  String get importOptionKpubDescription => 'Seuraa lompakon saldoa ja tapahtumia laajennetun julkisen avaimen avulla';
  ...
  @override
  String get importKpubClipboardError => 'Leikepyödän sisältö ei ole validi laajennettu julkinen avain';

  @override
  String get importKpubQrCodeError => 'QR-koodi ei sisällä validia laajennettua julkista avainta';

  @override
  String get importKpubInvalidMessage => 'Varmista, että syötit laajennetun julkisen avaimesi oikein!';

  @override
  String get receiveAddressListEmpty => 'Vastaanottajaosoitteiden lista on tyhjä';

  @override
  String get changeAddressListEmpty => 'Vaihtorahaosoitteiden lista on tyhjä';

  @override
  String get hintAddressListEmpty => 'Varmista osoitteiden suodatus oikeasta yläreunasta';
