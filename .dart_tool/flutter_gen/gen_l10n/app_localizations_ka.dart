...
class AppLocalizationsKa extends AppLocalizations {
  ...
  @override
  String get ackBackedUp => 'დარწმუნებული ხართ, რომ შექმენით თქვენი საიდუმლო ფრაზის სარეზერვო ასლი?';
  ...
  @override
  String get addNodeFailed => 'ვერ მოხერხდა Sedra-ს ნოუდის დამატება';
  ...
  @override
  String get addingNodeMessage => 'გთხოვთ მოიცადოთ იქამდე სანამ ვუკავშირდებით ნოუდს';
  ...
  @override
  String get contactsImportErr => 'დაფიქსირდა შეცდომა კონტაქტების იმპორტირებისას';
  ...
  @override
  String get createPasswordFirstParagraph => 'თქვენ შეგიძლიათ შექმნათ პაროლი თქვენს საფულეზე დამატებითი უსაფრთხოების დასამატებლად.';

  @override
  String get createPasswordHint => 'შექმენით პაროლი';

  @override
  String get createPasswordSecondParagraph => 'პაროლი არჩევითია, თქვენი საფულე დაცული იქნება თქვენი PIN-ით ან ბიომეტრიით, მიუხედავად იმისა დააყენებთ თუ არა პაროლს.';
  ...
  @override
  String get emptyCardIntroUtxos => 'ეს არის UTXO-ს გვერდი. ყველა UTXO თქვენს საფულეში გამოჩნდება აქ';
  ...
  @override
  String get exampleCardIntro => 'ეს არის ტრანზაქციების გვერდი. ტრანზაქციის გაგზავნის ან მიღების შემდეგ, იგი გამოჩნდება აქ.';
  ...
  @override
  String get fingerprintSeedBackup => 'გაიარეთ ავთენტიფიკაცია საიდუმლო ფრაზის სარეზერვო ასლის შესაქმნელად';
  ...
  @override
  String get importSecretPhraseHint => 'გთხოვთ ქვემოთ შეიყვანოთ თქვენი 24 სიტყვიანი საიდუმლო ფრაზა';

  @override
  String get importSecretPhraseHintCombo => 'გთხოვთ შეიყვანოთ თქვენი 12 ან 24 სიტყვიანი საიდუმლო ფრაზა ქვემოთ.';

  @override
  String get importSecretPhraseHintLegacy => 'გთხოვთ შეიყვანოთ თქვენი 12 სიტყვიანი საიდუმლო ფრაზა ქვემოთ.';
  ...
  @override
  String get insufficientBalanceDetails => 'თქვენ არ გაქვთ საკმარისი SDR ამ ტრანზაქციისთვის';
  ...
  @override
  String get invalidChecksumMessage => 'გთხოვთ შეამოწმოთ, რომ თქვენ მიერ შეყვანილი საიდუმლო ფრაზა\nშეყვანილია სწორად!';

  @override
  String get invalidKpubMessage => 'გთხოვთ შეამოწმოთ რომ თქვენი გაფართოებული საჯარო გასაღები შეყვანილია სწორად!';
  ...
  @override
  String get sedraDevFund => 'Sedra-ს Dev ფონდი';

  @override
  String get sedracoinWallet => 'SedraCoin საფულე';
  ...
  @override
  String get logoutDialogContent => 'დარწმუნებული ხართ რომ გსურთ ამ საფულიდან გასვლა?';
  ...
  @override
  String get nodeAddress => 'Sedra-ს ნოუდი ';

  @override
  String get nodeDeleteMessage => 'Დარწმუნებული ხართ რომ გსურთ წაშლა?';

  @override
  String get nodeDeleteTitle => 'წაიშალოს Sedra-ს ნოუდის კონფიგურაცია?';
  ...
  @override
  String get nodesSheetTitle => 'Sedra-ს ნოუდები';
  ...
  @override
  String get passwordNoLongerRequiredToOpenParagraph => 'ამ საფულის გასახსნელად პაროლი არ დაგჭირდებათ.';

  @override
  String get passwordWillBeRequiredToOpenParagraph => 'ეს პაროლი საჭირო იქნება ამ საფულის გასახსნელად.';

  @override
  String get passwordsDontMatch => 'პაროლები არ ემთხვევა';

  @override
  String get pasteMnemonicError => 'ბუფერში არსებული ინფორმაცია არ არის ვალიდური საიდუმლო ფრაზა';
  ...
  @override
  String get pinConfirmTitle => 'დაადასტურეთ თქვენი პინ';

  @override
  String get pinCreateTitle => 'შექმენით 6-ციფრა პინ';

  @override
  String get pinEnterTitle => 'შეიყვანეთ პინ';
  ...
  @override
  String get pinSeedBackup => 'შეიყვანეთ PIN საიდუმლო ფრაზის სარეზერვო ასლის შესაქმნელად';
  ...
  @override
  String get qrInvalidSeed => 'QR კოდი არ შეიცავს ვალიდურ seed-ს ან პირად გასაღებს ';
  ...
  @override
  String get removeWalletBiometricsMessage => 'ავთენტიფიკაცია საფულის ამოსაღებად';

  @override
  String get removeWalletDetail => 'ამ საფულის ამოღება ამოშლის საიდუმლო ფრაზას და საფულესთან დაკავშირებულ ყველა მონაცემს ამ მოწყობილობიდან. თუ საიდუმლო ფრაზის სარეზერვო ასლი არ არსებობს, თქვენ ვეღარასოდეს შეძლებთ თქვენს სახსრებზე წვდომას.';

  @override
  String get removeWalletPinMessage => 'შეიყვანეთ PIN საფულის ამოსაღებად';

  @override
  String get removeWalletReassurance => 'სანამ საიდუმლო ფრაზის სარეზერვო ასლი გაქვთ, სანერვიულო არაფერი გაქვთ.';

  @override
  String get requireAPasswordToOpenHeader => 'მოვითხოვოთ პაროლი ამ საფულის გასახსნელად?';
  ...
  @override
  String get secretInfo => 'შემდეგ ეკრანზე ნახავთ თქვენს საიდუმლო ფრაზას. ეს არის პაროლი თქვენს სახსრებზე წვდომისთვის. გადამწყვეტი მნიშვნელობა აქვს მისი სარეზერვო ასლის შენახვას, რომელიც არასოდეს უნდა გაუზიაროთ ვინმეს.';
  ...
  @override
  String get secretWarning => 'თუ დაკარგავთ თქვენს მოწყობილობას ან წაშლით აპლიკაციას, დაგჭირდებათ თქვენი საიდუმლო ფრაზა სახსრების დასაბრუნებლად!';
  ...
  @override
  String get sendTxProgressDescription => 'გთხოვთ, დაელოდოთ ტრანზაქციის გაგზავნას';
  ...
  @override
  String get shareSedraCoin => 'SedraCoin-ის გაზიარება';

  @override
  String get shareSedraCoinSubject => 'Kapsium-ის საფულის შემოწმება';

  @override
  String get shareSedraCoinText => 'იხილეთ SedraCoin - Sedra-ს მობილური საფულე. \nვებსაიტი - sedracoin.com';
  ...
  String transferComplete(String amount) {
    return '$amount SDR წარმატებით გადავიდა თქვენ SedraCoin-ის საფულეში.\n';
  }

  @override
  String transferConfirmInfo(String amount) {
    return 'აღმოჩენილია საფულე $amount SDR-ის ბალანსით.';
  }

  @override
  String get transferConfirmInfoSecond => 'შეეხეთ დადასტურებას სახსრების გადასარიცხად.\n';

  @override
  String get transferConfirmInfoThird => 'ტრანსფერის დასრულებას შეიძლება დასჭირდეს რამოდენიმე წამი.';

  @override
  String get transferError => 'ტრანსფერისას მოხდა შეცდომა. გთხოვთ სცადოთ მოგვიანებით.';
  ...
  @override
  String get transferNoFunds => 'ამ seed-ს არ აქვს SDR';

  @override
  String get transferQrScanError => 'ეს QR კოდი არ შეიცავს მოქმედ seed-ს.';

  @override
  String get transferQrScanHint => 'დაასკანირეთ Sedra\nseed ან პირადი გასაღები';
  ...
  @override
  String get walletSetupAddressDiscovery => 'მიმდინარეობს მისამართიების აღმოჩენა';
  ...
  String welcomeMessage(String version) {
    return 'მოგესალმებით\n\nეს არის SedraCoin-ის ვერსია $version - მობილური საფულე Sedra-სთვის';
  }

  @override
  String get welcomeText => 'კეთილი იყოს თქვენი მობრძანება SedraCoin-ში. დასაწყებათ, შეგიძლიათ შექმნათ ახალი საფულე ან დააიმპორტოთ არსებული.';
  ...
  String xMinutes(int minutes) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      minutes,
      locale: localeName,
      other: '$minutesString წუთი',
      one: '1 წუთი',
    );
    return 'შემდეგ $_temp0';
  }
  ...
  @override
  String get sedraUriInvalid => 'არასწორი Sedra URI';
  ...
  @override
  String get scanFailedMessage => 'სკანირება ვერ მოხერხდა, გთხოვთ მოგვიანებით სცადოთ';
  ...
  @override
  String get addressFilterDialogOptionNonZeroBalances => 'ბალანსიანი მისამართების ნახვა';

  @override
  String get importOption24WordsTitle => '24 სიტყვიანი საიდუმლო ფრაზის იმპორტი';

  @override
  String get importOption24WordsDescription => 'თავსებადია Cli Wallet-თან და Ledger-თან';

  @override
  String get importOption12WordsTitle => '12 სიტყვიანი საიდუმლო ფრაზის იმპორტი';

  @override
  String get importOption12WordsDescription => 'თავსებადია Web Wallet-თან და KDX-თან';

  @override
  String get importOptionKpubTitle => 'Watch Only Wallet-ის იმპორტი';

  @override
  String get importOptionKpubDescription => 'აკონტროლეთ საფულის ბალანსი და ტრანზაქციები გაფართოებული საჯარო გასაღების გამოყენებით';

  @override
  String get importKpub => 'Watch Only Wallet-ის იმპორტი';

  @override
  String get importKpubHint => 'გთხოვთ, შეიყვანოთ თქვენი გაფართოებული საჯარო გასაღები.';

  @override
  String get importKpubClipboardError => 'ბუფერში არსებული კონტენტი არ არის სწორი გაფართოებული საჯარო გასაღები';

  @override
  String get importKpubQrCodeError => 'QR კოდი არ შეიცავს მოქმედ გაფართოებულ საჯარო გასაღებს';

  @override
  String get importKpubInvalidMessage => 'გთხოვთ, შეამოწმოთ, რომ თქვენი გაფართოებული საჯარო გასაღები სწორად არის შეყვანილი!';
  ...
  @override
  String get hintAddressListEmpty => 'შეამოწმეთ მისამართის ფილტრი ზედა მარჯვენა კუთხიდან';
