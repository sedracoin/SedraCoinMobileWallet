...
abstract class AppLocalizations {
  ...
  /// No description provided for @sedraUriCopied.
  ///
  /// In en, this message translates to:
  /// **'Sedra URI Copied'**
  String get sedraUriCopied;

  /// No description provided for @sedraUriCopyFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to copy Sedra URI'**
  String get sedraUriCopyFailed;
  ...
  ///
  /// In en, this message translates to:
  /// **'You don\'t have enough SDR for this transaction'**
  ...
  /// No description provided for @sedraDevFund.
  ///
  /// In en, this message translates to:
  /// **'Sedra Dev Fund'**
  String get sedraDevFund;

  /// No description provided for @sedracoinWallet.
  ///
  /// In en, this message translates to:
  /// **'SedraCoin Wallet'**
  String get sedracoinWallet;
  ...
  /// No description provided for @shareSedraCoin.
  ///
  /// In en, this message translates to:
  /// **'Share SedraCoin'**
  String get shareSedraCoin;

  /// No description provided for @shareSedraCoinSubject.
  ///
  /// In en, this message translates to:
  /// **'Check out SedraCoin Wallet'**
  String get shareSedraCoinSubject;

  /// No description provided for @shareSedraCoinText.
  ///
  /// In en, this message translates to:
  /// **'Check out SedraCoin - Sedra Mobile Wallet.\nWebsite - sedracoin.com'**
  String get shareSedraCoinText;
  ...
  ///
  /// In en, this message translates to:
  /// **'{amount} SDR successfully transferred to your SedraCoin Wallet.\n'**
  String transferComplete(String amount);

  /// No description provided for @transferConfirmInfo.
  ///
  /// In en, this message translates to:
  /// **'A wallet with a balance of {amount} SDR has been detected.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This process will transfer the funds from a paper wallet to your SedraCoin wallet.\n\nTap the \"{button}\" button to start.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'This seed does not have any SDR on it'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Welcome to SedraCoin. To begin, you may create a new wallet or import an existing one.'**
  ...
  /// No description provided for @sedraUriInvalid.
  ///
  /// In en, this message translates to:
  /// **'Invalid Sedra URI'**
  String get sedraUriInvalid;
  ...
  /// No description provided for @buySedraSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Via Topper by Uphold'**
  String get buySedraSubtitle;

  /// No description provided for @buySedraTitle.
  ///
  /// In en, this message translates to:
  /// **'Buy Sedra'**
  String get buySedraTitle;

  /// No description provided for @buySedraMessage.
  ///
  /// In en, this message translates to:
  /// **'Buy \$SDR quickly & easily.'**
  String get buySedraMessage;

  /// No description provided for @buySedraMessageSecondary.
  ///
  /// In en, this message translates to:
  /// **'Service provided by Topper, Uphold\'s fiat-to-crypto onramp.'**
  String get buySedraMessageSecondary;
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['af', 'ar', 'bg', 'bn', 'ca', 'cs', 'da', 'de', 'el', 'en', 'es', 'eu', 'fa', 'fi', 'fr', 'he', 'hi', 'hu', 'id', 'it', 'ja', 'ka', 'ko', 'lv', 'ms', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'sl', 'sq', 'sr', 'sv', 'te', 'tl', 'tr', 'uk', 'ur', 'vi', 'zh'].contains(locale.languageCode);
