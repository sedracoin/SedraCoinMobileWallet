...
class ReceiveSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final sedraUri = SedraUri(address: receiveAddress.address, amount: amount);
    ...
    Future<void> copyUri() async {
      try {
        await Clipboard.setData(ClipboardData(text: sedraUri.toString()));
        UIUtil.showSnackbar(l10n.sedraUriCopied, context);
      } catch (_) {
        UIUtil.showSnackbar(l10n.sedraUriCopyFailed, context);
      }
    }
