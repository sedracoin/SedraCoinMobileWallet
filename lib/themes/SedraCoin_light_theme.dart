...
class SedracoinLightTheme extends BaseTheme {
  //static const deepBlue = Color(0xFF009688);
  static const deepBlue = Color(0xFF54AEFF);

  //static const green = Color(0xFF009688);
  static const green = Color(0xFF54AEFF);

  //static const greenLight = Color(0xFF9EEDD4);
  static const greenLight = Color(0xFF54AEFF);
