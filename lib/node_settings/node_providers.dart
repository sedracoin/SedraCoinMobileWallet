...
final sedraNodeSettingsProvider =
...
final sedraNodeOptionsProvider = Provider((ref) {
  final settings = ref.watch(sedraNodeSettingsProvider);
  return settings.options;
});

final sedraNodeConfigProvider = Provider((ref) {
  final settings = ref.watch(sedraNodeSettingsProvider);
