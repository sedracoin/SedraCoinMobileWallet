...
final sedraNodeConfigItemProvider =
...
class NodeItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final item = ref.watch(sedraNodeConfigItemProvider);
    final activeConfig = ref.watch(sedraNodeConfigProvider);
    ...
    Future<void> change() async {
      ...
      final notifier = ref.read(sedraNodeSettingsProvider.notifier);
