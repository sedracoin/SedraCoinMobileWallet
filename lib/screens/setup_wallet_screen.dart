  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> setupWallet() async {
      try {
        ...
        // address discovery
        final client = ref.read(sedraClientProvider);
        final api = ref.read(sedraApiServiceProvider);
        ...
        if (network == SedraNetwork.mainnet && !introData.generated) {
              ...
              child: Column(
                ...
                children: [
                  FractionallySizedBox(
                    ...
                    child: FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Image.asset('assets/sedra.png'),
                    ),
                  ),
                  Column(
                    children: [
