...
import '../sedra/types.dart';
import '../l10n/l10n.dart';
import '../themes/SedraCoin_light_theme.dart';
...
class MainCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final sedraBalance = ref.watch(formatedTotalBalanceProvider);
    final fiatBalance = ref.watch(formatedTotalFiatProvider);
    final sedraPrice = ref.watch(formatedSedraPriceProvider);
    ...
    Future<void> scanQrCode() async {
      ...
      final uri = SedraUri.tryParse(data, prefix: prefix);
                      ...
                      Container(
                        child: FittedBox(
                          ...
                          child: Row(
                            children: [
                              Image.asset(
                                'assets/sedra_transparent_180.png',
                                width: 30,
                                color: theme is SedracoinLightTheme
                                    ? theme.primary
                                    : null,
                              ),
