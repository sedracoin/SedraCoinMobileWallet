...
class SharedPrefsUtil {
  ...
  // Keys
  static const String first_launch_key = 'fsedracoin_first_launch';
  static const String auth_method = 'fsedracoin_auth_method';
  static const String cur_currency = 'fsedracoin_currency_pref';
  static const String cur_language = 'fsedracoin_language_pref';
  static const String cur_theme = 'fsedracoin_theme_pref';
  static const String firstcontact_added = 'fsedracoin_first_contact_added';
  // If user has seen the root/jailbreak warning yet
  static const String has_shown_root_warning = 'fsedracoin_root_warn';
  static const String notice_shown = 'fsedracoin_notice_shown';
  ...
  ThemeSetting getTheme() {
    return ThemeSetting(ThemeOptions.values.byName(get(
      cur_theme,
      defaultValue: ThemeOptions.SEDRACOIN_DARK.name,
    )));
  }
