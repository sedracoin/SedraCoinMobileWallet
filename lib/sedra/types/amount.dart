...
class Amount with _$Amount {
  ...
  factory Amount.raw(BigInt raw, {TokenInfo tokenInfo = TokenInfo.sedra}) =>
      Amount(raw: raw, tokenInfo: tokenInfo);
  factory Amount.value(
    Decimal value, {
    TokenInfo tokenInfo = TokenInfo.sedra,
  }) =>
      Amount(
  ...
  factory Amount.rawInt(int raw, {TokenInfo tokenInfo = TokenInfo.sedra}) {
    final rawBigInt = BigInt.from(raw);
    return Amount(raw: rawBigInt, tokenInfo: tokenInfo);
  }

  factory Amount.rawInt64(Int64 raw, {TokenInfo tokenInfo = TokenInfo.sedra}) {
