...
class BuySheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    void buySedra() {
      ...
      final uri = Uri.https('sedra-topper.vercel.app', '/api/topper', {
        'source': source,
        'target': 'SDR',
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text(
                l10n.buySedraMessage + '\n' + l10n.buySedraMessageSecondary,
